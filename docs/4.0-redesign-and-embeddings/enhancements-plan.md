...
| Tier 3: items 11–15 | ✅ Item 13 (T3-1). ✅ Redirects module (T3-6). ✅ Item 12's consolidation flow (T3-7). ⬜ Item 11 (silos, T3-2/T3-3) is next; D16 is decided. ⏸ Items 14 and 15 are on hold |
...
Order (updated 2026-09-24): 13 → 12 → 11. Items 13 and 12 are done; 11 is next. Items 14 and 15 are on hold. The slices are defined in the plan, section 2.
...
| T3-2 | Silo model (11) | ⬜ | Next. The member ↔ pillar link matrix and a gap score, from the link index and clusters. |
| T3-3 | Silo UI and Fix silo (11) | ⬜ | Content hub "Silos" rail item. Fix silo per D16: members → pillar links in the text, plus a render-time "In this guide" list on the pillar. |
