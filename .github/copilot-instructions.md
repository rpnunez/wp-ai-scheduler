...
- Treat `../AGENTS.md` as the canonical repository and architecture context. Do not duplicate that guidance here.
...
- For larger subsystem details, consult `../docs/AI_AGENT_REFERENCE.md` and `../docs/DEVELOPMENT_GUIDELINES.md`.
