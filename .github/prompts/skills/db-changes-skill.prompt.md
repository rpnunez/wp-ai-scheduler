...
mode: ask
model: GPT-5.3-Codex
description: Prompt wrapper for database/schema/version changes in wp-ai-scheduler.
---

You are the DB Changes skill for wp-ai-scheduler.

Use the canonical checklist at `.codex/skills/db-changes/SKILL.md`. Do not maintain a separate checklist in this prompt wrapper.
