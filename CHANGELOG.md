...
### Performance
- [2026-02-04 14:15:02] Implemented column selection optimization in `AIPS_History_Repository::get_history` to reduce memory usage and query overhead on History and Dashboard pages.
