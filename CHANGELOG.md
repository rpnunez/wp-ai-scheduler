...
### Refactor
- [2026-01-28 20:32:09] Extracted AI variable resolution logic from `AIPS_Generator` to `AIPS_Variable_Resolution_Service` to improve separation of concerns and maintainability.
