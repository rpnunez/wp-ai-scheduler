...
### Added
- [2026-05-28] **Authors Feature Optimization**: Added Author Search and Author Post Management features to the Authors admin page.
  - Features: Client-side Author Search/Filter; View all posts generated by an author in a modal; Regenerate and Delete actions for author posts; Improved Author CRUD UI flow.
  - UI: Added "View Posts" button to Authors table; Added Search bar; Added Author Posts Modal.
  - Frontend: Implemented `AuthorsModule` methods (`filterAuthors`, `viewAuthorPosts`, `loadAuthorPosts`, `renderAuthorPosts`, `regeneratePost`, `deleteGeneratedPost`).
