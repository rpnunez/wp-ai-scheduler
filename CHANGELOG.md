...
### Added
- [2025-05-24 10:00:00] Added client-side search functionality to the Article Structures admin page (both Structures and Sections tabs) to improve usability for large lists.
