...
### Changed
- Modernized status badges (`.aips-badge`) across all admin interfaces to feature a pill shape and embedded contextual Dashicons for improved readability and state communication.
