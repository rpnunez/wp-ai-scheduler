...
## 2025-12-23 - [Extract AIPS_Prompt_Builder] **Context:** AIPS_Generator was violating SRP by mixing orchestration with prompt string construction logic, making it hard to test and maintain. **Decision:** Extracted prompt construction logic into a new AIPS_Prompt_Builder service. **Consequence:** Improved separation of concerns; AIPS_Generator now focuses on orchestration. Added one new class file.
