...
class ComposerStaticInit35ade7d9f044c669e934e5a8a32e7934
{
    ...
    public static $classMap = array (
        ...
        'AIPS_Article_Structure_Repository_Test' => __DIR__ . '/../..' . '/tests/test-article-structure-repository.php',
        ...
        'AIPS_Author_Topics_Bulk_Actions_Test' => __DIR__ . '/../..' . '/tests/test-author-topics-bulk-actions.php',
        ...
        'AIPS_Feedback_Repository_Test' => __DIR__ . '/../..' . '/tests/test-feedback-repository.php',
        ...
        'AIPS_History_Repository_Performance_Test' => __DIR__ . '/../..' . '/tests/test-history-repository-performance.php',
        'AIPS_History_Repository_Test' => __DIR__ . '/../..' . '/tests/test-history-repository.php',
        ...
        'AIPS_Onboarding_Wizard_Test' => __DIR__ . '/../..' . '/tests/test-onboarding-wizard.php',
        ...
        'AIPS_Post_Creator_SEO_Test' => __DIR__ . '/../..' . '/tests/test-post-creator-seo.php',
        ...
        'AIPS_Post_Manager_SEO_Metadata_Test' => __DIR__ . '/../..' . '/tests/test-post-manager-seo.php',
        ...
        'AIPS_Prompt_Template_Defaults' => __DIR__ . '/../..' . '/includes/class-aips-prompt-template-defaults.php',
        'AIPS_Prompt_Template_Group_Repository' => __DIR__ . '/../..' . '/includes/class-aips-prompt-template-group-repository.php',
        'AIPS_Prompt_Template_Item_Repository' => __DIR__ . '/../..' . '/includes/class-aips-prompt-template-item-repository.php',
        ...
        'AIPS_Structures_Controller_Test' => __DIR__ . '/../..' . '/tests/test-structures-controller.php',
        ...
        'AIPS_Template_Type_Selector_Test' => __DIR__ . '/../..' . '/tests/test-template-type-selector.php',
        ...
        'AIPS_Test_History_Container' => __DIR__ . '/../..' . '/tests/test-notifications.php',
        'AIPS_Test_History_Service' => __DIR__ . '/../..' . '/tests/test-notifications.php',
        'AIPS_Test_Notifications_Repository' => __DIR__ . '/../..' . '/tests/test-notifications.php',
        'AIPS_Test_Stub_AI_Service_For_Feedback' => __DIR__ . '/../..' . '/tests/test-author-topics-generator-feedback-guidance.php',
        'AIPS_Test_Stub_AI_Service_For_Fuzzy' => __DIR__ . '/../..' . '/tests/test-author-topics-generator-fuzzy-duplicates.php',
        'AIPS_Test_Stub_AI_Service_For_Prompt_Builder' => __DIR__ . '/../..' . '/tests/test-prompt-builder.php',
        'AIPS_Test_Stub_AI_Service_For_Suggestions' => __DIR__ . '/../..' . '/tests/test-author-suggestions-service.php',
        'AIPS_Test_Stub_History_Container_For_Suggestions' => __DIR__ . '/../..' . '/tests/test-author-suggestions-service.php',
        'AIPS_Test_Stub_History_Repository_For_Correlation' => __DIR__ . '/../..' . '/tests/test-correlation-id.php',
        'AIPS_Test_Stub_History_Service_For_Suggestions' => __DIR__ . '/../..' . '/tests/test-author-suggestions-service.php',
        'AIPS_Test_Stub_Logger_For_Feedback' => __DIR__ . '/../..' . '/tests/test-author-topics-generator-feedback-guidance.php',
        'AIPS_Test_Stub_Logger_For_Fuzzy' => __DIR__ . '/../..' . '/tests/test-author-topics-generator-fuzzy-duplicates.php',
        'AIPS_Test_Stub_Logger_For_Suggestions' => __DIR__ . '/../..' . '/tests/test-author-suggestions-service.php',
        'AIPS_Test_Templates_Save_Stub' => __DIR__ . '/../..' . '/tests/test-templates-controller-save.php',
        ...
        'AIPS_Topic_Penalty_Service_Test' => __DIR__ . '/../..' . '/tests/test-topic-penalty-service.php',
        ...
        'AIPS_Voices_Repository_Test' => __DIR__ . '/../..' . '/tests/test-voices-repository.php',
        ...
        'Mock_WPDB_Query_Counter' => __DIR__ . '/../..' . '/tests/test-repository-identity-map-cache.php',
        'Mock_WPDB_Stateful_Voices' => __DIR__ . '/../..' . '/tests/test-voices-repository.php',
        ...
        'Test_AIPS_AI_Edit_Controller' => __DIR__ . '/../..' . '/tests/test-ai-edit-controller.php',
        'Test_AIPS_AI_Service' => __DIR__ . '/../..' . '/tests/test-ai-service.php',
        'Test_AIPS_Admin_Bar_Cache' => __DIR__ . '/../..' . '/tests/test-admin-bar-cache.php',
        'Test_AIPS_Admin_Menu' => __DIR__ . '/../..' . '/tests/test-admin-menu.php',
        'Test_AIPS_Ajax_Registry_Response' => __DIR__ . '/../..' . '/tests/test-ajax-registry-response.php',
        'Test_AIPS_Author_Post_Generator_Expansion' => __DIR__ . '/../..' . '/tests/test-author-post-generator-expansion.php',
        'Test_AIPS_Bulk_Generator_Service' => __DIR__ . '/../..' . '/tests/test-bulk-generator-service.php',
        'Test_AIPS_Cache' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Array_Driver' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Db_Driver' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Factory' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Factory_Named' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Factory_Named_Guard' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Redis_Driver' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Session_Driver' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Cache_Wp_Object_Cache_Driver' => __DIR__ . '/../..' . '/tests/test-cache.php',
        'Test_AIPS_Calendar_Controller' => __DIR__ . '/../..' . '/tests/test-calendar-controller.php',
        'Test_AIPS_Config' => __DIR__ . '/../..' . '/tests/test-config.php',
        'Test_AIPS_Config_Option_Cache' => __DIR__ . '/../..' . '/tests/test-config-option-cache.php',
        'Test_AIPS_Container' => __DIR__ . '/../..' . '/tests/test-container.php',
        'Test_AIPS_Container_Bindings' => __DIR__ . '/../..' . '/tests/test-container-bindings.php',
        'Test_AIPS_Context_Boot' => __DIR__ . '/../..' . '/tests/test-context-boot.php',
        'Test_AIPS_Correlation_ID' => __DIR__ . '/../..' . '/tests/test-correlation-id.php',
        'Test_AIPS_DB_Schema' => __DIR__ . '/../..' . '/tests/test-db-schema.php',
        'Test_AIPS_Generate_Now_Timing' => __DIR__ . '/../..' . '/tests/test-generate-now-timing.php',
        'Test_AIPS_Generation_Context' => __DIR__ . '/../..' . '/tests/Test_AIPS_Generation_Context.php',
        'Test_AIPS_Generation_Logger' => __DIR__ . '/../..' . '/tests/test-generation-logger.php',
        'Test_AIPS_Generation_Result' => __DIR__ . '/../..' . '/tests/test-typed-dtos.php',
        'Test_AIPS_History_Security' => __DIR__ . '/../..' . '/tests/test-security-history.php',
        'Test_AIPS_Image_Service' => __DIR__ . '/../..' . '/tests/test-image-service.php',
        'Test_AIPS_Image_Service_Collision' => __DIR__ . '/../..' . '/tests/test-image-service-collision.php',
        'Test_AIPS_Internal_Link_Inserter_Service' => __DIR__ . '/../..' . '/tests/test-internal-link-inserter-service.php',
        'Test_AIPS_Internal_Links' => __DIR__ . '/../..' . '/tests/test-internal-links.php',
        'Test_AIPS_Interval_Calculator' => __DIR__ . '/../..' . '/tests/test-interval-calculator.php',
        'Test_AIPS_Logger_Performance' => __DIR__ . '/../..' . '/tests/test-logger-performance.php',
        'Test_AIPS_Manual_Schedule_Execution' => __DIR__ . '/../..' . '/tests/test-manual-schedule-execution.php',
        'Test_AIPS_Markdown_Parser' => __DIR__ . '/../..' . '/tests/test-aips-markdown-parser.php',
        'Test_AIPS_Metrics_Repository' => __DIR__ . '/../..' . '/tests/test-metrics-repository.php',
        'Test_AIPS_Mock_Scheduler' => __DIR__ . '/../..' . '/tests/test-bulk-schedule.php',
        'Test_AIPS_Notification_Registry' => __DIR__ . '/../..' . '/tests/test-notification-registry.php',
        'Test_AIPS_Notification_Senders' => __DIR__ . '/../..' . '/tests/test-notification-senders.php',
        'Test_AIPS_Notification_Template' => __DIR__ . '/../..' . '/tests/test-notifications.php',
        'Test_AIPS_Notification_Templates' => __DIR__ . '/../..' . '/tests/test-notifications.php',
        'Test_AIPS_Notifications' => __DIR__ . '/../..' . '/tests/test-notifications-repository.php',
        'Test_AIPS_Notifications_Service' => __DIR__ . '/../..' . '/tests/test-notifications.php',
        'Test_AIPS_Planner_BulkSchedule' => __DIR__ . '/../..' . '/tests/test-bulk-schedule.php',
        'Test_AIPS_Planner_Bulk_Generate_Now' => __DIR__ . '/../..' . '/tests/test-planner-bulk-generate-now.php',
        'Test_AIPS_Planner_Testable' => __DIR__ . '/../..' . '/tests/test-planner-bulk-generate-now.php',
        'Test_AIPS_Post_Review_Repository' => __DIR__ . '/../..' . '/tests/test-post-review-repository.php',
        'Test_AIPS_Prompt_Builder' => __DIR__ . '/../..' . '/tests/test-prompt-builder.php',
        'Test_AIPS_Prompt_Template_Defaults' => __DIR__ . '/../..' . '/tests/Test_AIPS_Prompt_Template_Defaults.php',
        'Test_AIPS_Prompt_Template_Group_Repository' => __DIR__ . '/../..' . '/tests/Test_AIPS_Prompt_Template_Group_Repository.php',
        'Test_AIPS_Prompt_Template_Item_Repository' => __DIR__ . '/../..' . '/tests/Test_AIPS_Prompt_Template_Item_Repository.php',
        'Test_AIPS_Resilience_Improvements' => __DIR__ . '/../..' . '/tests/test-resilience-improvements.php',
        'Test_AIPS_Schedule_Controller_Bulk' => __DIR__ . '/../..' . '/tests/test-schedule-controller-bulk.php',
        'Test_AIPS_Schedule_Controller_Run_Now' => __DIR__ . '/../..' . '/tests/test-schedule-controller-run-now.php',
        'Test_AIPS_Schedule_Controller_Save' => __DIR__ . '/../..' . '/tests/test-schedule-controller-save.php',
        'Test_AIPS_Schedule_Entry' => __DIR__ . '/../..' . '/tests/test-typed-dtos.php',
        'Test_AIPS_Schedule_History' => __DIR__ . '/../..' . '/tests/test-schedule-history.php',
        'Test_AIPS_Schedule_Repository_Bulk' => __DIR__ . '/../..' . '/tests/test-schedule-repository-bulk.php',
        'Test_AIPS_Scheduler_Hook_Registration' => __DIR__ . '/../..' . '/tests/test-scheduler-hook-registration.php',
        'Test_AIPS_Scheduler_Resilience' => __DIR__ . '/../..' . '/tests/test-scheduler-resilience.php',
        'Test_AIPS_Scheduler_Save' => __DIR__ . '/../..' . '/tests/test-scheduler-save.php',
        'Test_AIPS_Singleton_Instances' => __DIR__ . '/../..' . '/tests/test-singleton-instances.php',
        'Test_AIPS_Site_Context' => __DIR__ . '/../..' . '/tests/test-site-context.php',
        'Test_AIPS_Sources' => __DIR__ . '/../..' . '/tests/test-sources.php',
        'Test_AIPS_Sources_Data_Repository' => __DIR__ . '/../..' . '/tests/test-sources-data-repository.php',
        'Test_AIPS_Sources_Fetcher' => __DIR__ . '/../..' . '/tests/test-sources-fetcher.php',
        'Test_AIPS_System_Diagnostics_Service' => __DIR__ . '/../..' . '/tests/test-aips-system-diagnostics-service.php',
        'Test_AIPS_Telemetry' => __DIR__ . '/../..' . '/tests/test-telemetry.php',
        'Test_AIPS_Template_Data' => __DIR__ . '/../..' . '/tests/test-typed-dtos.php',
        'Test_AIPS_Template_Processor' => __DIR__ . '/../..' . '/tests/test-template-processor.php',
        'Test_AIPS_Templates_Controller_Preview' => __DIR__ . '/../..' . '/tests/test-templates-controller-preview.php',
        'Test_AIPS_Templates_Controller_Save' => __DIR__ . '/../..' . '/tests/test-templates-controller-save.php',
        'Test_AIPS_Templates_Interval' => __DIR__ . '/../..' . '/tests/test-templates-interval.php',
        'Test_AIPS_Token_Budget' => __DIR__ . '/../..' . '/tests/test-token-budget.php',
        'Test_AIPS_Upgrades' => __DIR__ . '/../..' . '/tests/test-upgrades.php',
        'Test_Article_Structure_Repository_Cache' => __DIR__ . '/../..' . '/tests/test-repository-identity-map-cache.php',
        'Test_Author_Suggestions_Service' => __DIR__ . '/../..' . '/tests/test-author-suggestions-service.php',
        'Test_Author_Topics_Controller_Delegation' => __DIR__ . '/../..' . '/tests/test-author-topics-controller-delegation.php',
        'Test_Author_Topics_Generator_Feedback_Guidance' => __DIR__ . '/../..' . '/tests/test-author-topics-generator-feedback-guidance.php',
        'Test_Author_Topics_Generator_Fuzzy_Duplicates' => __DIR__ . '/../..' . '/tests/test-author-topics-generator-fuzzy-duplicates.php',
        'Test_Authors_Repository_Cache' => __DIR__ . '/../..' . '/tests/test-repository-identity-map-cache.php',
        'Test_Bug_Hunter_Filesystem_Errors' => __DIR__ . '/../..' . '/tests/test-bug-hunter-filesystem-errors.php',
        'Test_Bug_Hunter_JSON_Errors' => __DIR__ . '/../..' . '/tests/test-bug-hunter-json-errors.php',
        'Test_Bulk_Schedule' => __DIR__ . '/../..' . '/tests/test-bulk-schedule.php',
        'Test_Component_Regeneration_Service' => __DIR__ . '/../..' . '/tests/test-component-regeneration-service.php',
        'Test_Generated_Posts_Controller' => __DIR__ . '/../..' . '/tests/test-generated-posts-controller.php',
        'Test_Generation_Queue' => __DIR__ . '/../..' . '/tests/test-generation-queue.php',
        'Test_History_Template' => __DIR__ . '/../..' . '/tests/test-history-template.php',
        'Test_N_Plus_One' => __DIR__ . '/../..' . '/tests/test-n-plus-one.php',
        'Test_Partial_Generation_State_Reconciler' => __DIR__ . '/../..' . '/tests/test-partial-generation-state-reconciler.php',
        'Test_Prompt_Builder_Authors' => __DIR__ . '/../..' . '/tests/test-prompt-builder-authors.php',
        'Test_Prompt_Builder_Post_Content' => __DIR__ . '/../..' . '/tests/test-prompt-builder-post-content.php',
        'Test_Prompt_Builder_Post_Excerpt' => __DIR__ . '/../..' . '/tests/test-prompt-builder-post-excerpt.php',
        'Test_Prompt_Builder_Post_Featured_Image' => __DIR__ . '/../..' . '/tests/test-prompt-builder-post-featured-image.php',
        'Test_Prompt_Builder_Post_Title' => __DIR__ . '/../..' . '/tests/test-prompt-builder-post-title.php',
        'Test_Prompt_Builder_Taxonomy' => __DIR__ . '/../..' . '/tests/test-prompt-builder-taxonomy.php',
        'Test_Prompt_Section_Repository_Cache' => __DIR__ . '/../..' . '/tests/test-repository-identity-map-cache.php',
        ...
        'Test_Template_Repository_Cache' => __DIR__ . '/../..' . '/tests/test-repository-identity-map-cache.php',
        'Test_Topic_Posts_View' => __DIR__ . '/../..' . '/tests/test-topic-posts-view.php',
        'Test_Trending_Topics_Repository' => __DIR__ . '/../..' . '/tests/test-trending-topics-repository.php',
        'Test_Voices_Repository_Cache' => __DIR__ . '/../..' . '/tests/test-repository-identity-map-cache.php',
