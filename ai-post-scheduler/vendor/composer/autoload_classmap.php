...
return array(
    ...
    'AIPS_AI_Conversation' => $baseDir . '/includes/class-aips-ai-conversation.php',
    'AIPS_AI_Edit_Controller' => $baseDir . '/includes/class-aips-ai-edit-controller.php',
    'AIPS_AI_Provider_Factory' => $baseDir . '/includes/class-aips-ai-provider-factory.php',
    'AIPS_AI_Provider_Interface' => $baseDir . '/includes/interface-aips-ai-provider-interface.php',
    ...
    'AIPS_Admin_Flow_Controller' => $baseDir . '/includes/class-aips-admin-flow-controller.php',
    ...
    'AIPS_Affiliate_Link_Inserter_Service' => $baseDir . '/includes/class-aips-affiliate-link-inserter-service.php',
    'AIPS_Affiliate_Links_Controller' => $baseDir . '/includes/class-aips-affiliate-links-controller.php',
    'AIPS_Affiliate_Links_Repository' => $baseDir . '/includes/class-aips-affiliate-links-repository.php',
    'AIPS_Affiliate_Links_Service' => $baseDir . '/includes/class-aips-affiliate-links-service.php',
    ...
    'AIPS_Authors_Controller_Generate_Topics_Now_Test' => $baseDir . '/tests/test-authors-controller-generate-topics-now.php',
    ...
    'AIPS_Campaigns_Controller' => $baseDir . '/includes/class-aips-campaigns-controller.php',
    'AIPS_Campaigns_Repository' => $baseDir . '/includes/class-aips-campaigns-repository.php',
    ...
    'AIPS_Content_Auditor_Controller' => $baseDir . '/includes/class-aips-content-auditor-controller.php',
    'AIPS_Content_Auditor_Engine' => $baseDir . '/includes/class-aips-content-auditor-engine.php',
    'AIPS_Content_Auditor_Repository' => $baseDir . '/includes/class-aips-content-auditor-repository.php',
    'AIPS_Content_Auditor_Scanner' => $baseDir . '/includes/class-aips-content-auditor-scanner.php',
    'AIPS_Content_Digest' => $baseDir . '/includes/class-aips-content-digest.php',
    'AIPS_Content_Indexer_Controller' => $baseDir . '/includes/class-aips-content-indexer-controller.php',
    'AIPS_Content_Indexer_Service' => $baseDir . '/includes/class-aips-content-indexer-service.php',
    ...
    'AIPS_Data_Management_Repository' => $baseDir . '/includes/class-aips-data-management-repository.php',
    ...
    'AIPS_Deduplication_Service' => $baseDir . '/includes/class-aips-deduplication-service.php',
    ...
    'AIPS_Embeddings_Repository' => $baseDir . '/includes/class-aips-embeddings-repository.php',
    ...
    'AIPS_History_Event_Status' => $baseDir . '/includes/class-aips-history-event-status.php',
    'AIPS_History_Event_Type' => $baseDir . '/includes/class-aips-history-event-type.php',
    'AIPS_History_Event_View' => $baseDir . '/includes/class-aips-history-event-view.php',
    'AIPS_History_Query_Service' => $baseDir . '/includes/class-aips-history-query-service.php',
    ...
    'AIPS_History_Subject' => $baseDir . '/includes/class-aips-history-subject.php',
    ...
    'AIPS_Integration_ACF' => $baseDir . '/includes/class-aips-integration-acf.php',
    'AIPS_Integration_Field_Prompt_Builder' => $baseDir . '/includes/class-aips-integration-field-prompt-builder.php',
    'AIPS_Integration_Interface' => $baseDir . '/includes/interface-aips-integration-interface.php',
    'AIPS_Integration_Manager' => $baseDir . '/includes/class-aips-integration-manager.php',
    'AIPS_Integration_Mappings_Repository' => $baseDir . '/includes/class-aips-integration-mappings-repository.php',
    'AIPS_Integration_Native_Meta' => $baseDir . '/includes/class-aips-integration-native-meta.php',
    'AIPS_Integration_Registry' => $baseDir . '/includes/class-aips-integration-registry.php',
    'AIPS_Integrations_Controller' => $baseDir . '/includes/class-aips-integrations-controller.php',
    ...
    'AIPS_JSON_Extractor' => $baseDir . '/includes/class-aips-json-extractor.php',
    'AIPS_Job_Definition' => $baseDir . '/includes/job/class-aips-job-definition.php',
    'AIPS_Job_Dispatcher' => $baseDir . '/includes/job/class-aips-job-dispatcher.php',
    'AIPS_Job_Progress_Tracker' => $baseDir . '/includes/job/class-aips-job-progress-tracker.php',
    ...
    'AIPS_Null_AI_Provider' => $baseDir . '/includes/providers/class-aips-null-ai-provider.php',
    ...
    'AIPS_Outcome_Rate' => $baseDir . '/includes/class-aips-outcome-rate.php',
    ...
    'AIPS_Post_Slices_Controller' => $baseDir . '/includes/class-aips-post-slices-controller.php',
    'AIPS_Post_Slices_Repository' => $baseDir . '/includes/class-aips-post-slices-repository.php',
    ...
    'AIPS_Prompt_Builder_Diversity_Injector' => $baseDir . '/includes/class-aips-prompt-builder-diversity-injector.php',
    ...
    'AIPS_Related_Posts_Frontend' => $baseDir . '/includes/class-aips-related-posts-frontend.php',
    'AIPS_Related_Posts_Service' => $baseDir . '/includes/class-aips-related-posts-service.php',
    'AIPS_Relationships_Repository' => $baseDir . '/includes/class-aips-relationships-repository.php',
    'AIPS_Repository_Cache_Config' => $baseDir . '/includes/class-aips-repository-cache-config.php',
    'AIPS_Repository_Cache_Dependencies' => $baseDir . '/includes/class-aips-repository-cache-dependencies.php',
    'AIPS_Repository_Cache_Key_Builder' => $baseDir . '/includes/class-aips-repository-cache-key-builder.php',
    'AIPS_Repository_Cache_Observer' => $baseDir . '/includes/class-aips-repository-cache-observer.php',
    ...
    'AIPS_Schedule_Batch_Resume_Service' => $baseDir . '/includes/class-aips-schedule-batch-resume-service.php',
    ...
    'AIPS_Slice_Configuration' => $baseDir . '/includes/job/class-aips-slice-configuration.php',
    ...
    'AIPS_Stress_Test_Controller' => $baseDir . '/includes/class-aips-stress-test-controller.php',
    'AIPS_Stress_Test_Fixed_Mappings_Repository' => $baseDir . '/includes/class-aips-stress-test-service.php',
    'AIPS_Stress_Test_Resilience_Config' => $baseDir . '/includes/class-aips-stress-test-service.php',
    'AIPS_Stress_Test_Service' => $baseDir . '/includes/class-aips-stress-test-service.php',
    ...
    'AIPS_Studio_Controller' => $baseDir . '/includes/class-aips-studio-controller.php',
    'AIPS_Stub_AI_Provider' => $baseDir . '/tests/Test_AIPS_AI_Service_With_Provider.php',
    ...
    'AIPS_System_Status_Diagnostics_Service' => $baseDir . '/includes/class-aips-system-status-diagnostics-service.php',
    ...
    'AIPS_Template_Entry' => $baseDir . '/includes/class-aips-template-entry.php',
    ...
    'AIPS_Test_Cache_Index_Recorder' => $baseDir . '/tests/Test_AIPS_Cache.php',
    'AIPS_Test_Cache_Tag_Observer_Logger' => $baseDir . '/tests/Test_AIPS_Cache.php',
    'AIPS_Test_Cacheable_Repository_Logger' => $baseDir . '/tests/Test_AIPS_Cacheable_Repository.php',
    'AIPS_Test_Cacheable_Repository_Subject' => $baseDir . '/tests/Test_AIPS_Cacheable_Repository.php',
    'AIPS_Test_Campaigns_Repository_WPDB_Stub' => $baseDir . '/tests/Test_AIPS_Campaigns_Repository.php',
    'AIPS_Test_Conversation_Meow_Stub' => $baseDir . '/tests/Test_AIPS_AI_Conversation.php',
    'AIPS_Test_Conversational_AI_Service' => $baseDir . '/tests/Test_AIPS_Generator_Conversational.php',
    'AIPS_Test_Conversational_History_Container' => $baseDir . '/tests/Test_AIPS_Generator_Conversational.php',
    'AIPS_Test_Conversational_History_Service' => $baseDir . '/tests/Test_AIPS_Generator_Conversational.php',
    'AIPS_Test_Conversational_Post_Manager' => $baseDir . '/tests/Test_AIPS_Generator_Conversational.php',
    'AIPS_Test_Generator_Required_Content_AI_Service' => $baseDir . '/tests/Test_AIPS_Generator_Required_Content.php',
    'AIPS_Test_Generator_Required_Content_History_Container' => $baseDir . '/tests/Test_AIPS_Generator_Required_Content.php',
    'AIPS_Test_Generator_Required_Content_History_Service' => $baseDir . '/tests/Test_AIPS_Generator_Required_Content.php',
    'AIPS_Test_Generator_Required_Content_Post_Manager' => $baseDir . '/tests/Test_AIPS_Generator_Required_Content.php',
    ...
    'AIPS_Test_Meow_Engine_Stub' => $baseDir . '/tests/Test_AIPS_Meow_AI_Provider.php',
    'AIPS_Test_Notifications_Repository' => $baseDir . '/tests/Test_AIPS_Notification_Template.php',
    'AIPS_Test_Repository_Cache_Observer_Failing_Logger' => $baseDir . '/tests/Test_AIPS_Repository_Cache_Observer.php',
    'AIPS_Test_Repository_Cache_Observer_Logger' => $baseDir . '/tests/Test_AIPS_Repository_Cache_Observer.php',
    'AIPS_Test_Stress_AI_Service' => $baseDir . '/tests/Test_AIPS_Stress_Test_Service.php',
    'AIPS_Test_Stress_Base_Config' => $baseDir . '/tests/Test_AIPS_Stress_Test_Service.php',
    'AIPS_Test_Stress_Logger' => $baseDir . '/tests/Test_AIPS_Stress_Test_Service.php',
    'AIPS_Test_Stress_Meta_AI_Service' => $baseDir . '/tests/Test_AIPS_Stress_Test_Service.php',
    'AIPS_Test_Stub_AI_Service' => $baseDir . '/tests/Test_AIPS_Integration_Manager.php',
    ...
    'AIPS_Test_Stub_History_Repository' => $baseDir . '/tests/Test_AIPS_Post_History_UI.php',
    ...
    'AIPS_Test_Stub_Integration' => $baseDir . '/tests/Test_AIPS_Integration_Registry.php',
    ...
    'AIPS_Test_Stub_Manager_Integration' => $baseDir . '/tests/Test_AIPS_Integration_Manager.php',
    'AIPS_Test_Templates_Clone_Stub' => $baseDir . '/tests/Test_AIPS_Templates_Controller_Clone.php',
    'AIPS_Test_Templates_Save_Stub' => $baseDir . '/tests/Test_AIPS_Templates_Controller_Save.php',
    'AIPS_Test_Unavailable_Integration' => $baseDir . '/tests/Test_AIPS_Integration_Registry.php',
    'AIPS_Test_WP_AI_Client_Builder' => $baseDir . '/tests/Test_AIPS_WP_AI_Client_Provider.php',
    'AIPS_Test_WP_AI_Client_Builder_Erroring_Chain' => $baseDir . '/tests/Test_AIPS_WP_AI_Client_Provider.php',
    'AIPS_Test_WP_AI_Client_Builder_Without_JSON' => $baseDir . '/tests/Test_AIPS_WP_AI_Client_Provider.php',
    'AIPS_Test_WP_AI_Client_Image_File' => $baseDir . '/tests/Test_AIPS_WP_AI_Client_Provider.php',
    ...
    'AIPS_WP_AI_Client_Provider' => $baseDir . '/includes/providers/class-aips-wp-ai-client-provider.php',
    ...
    'Test_AIPS_AI_Conversation' => $baseDir . '/tests/Test_AIPS_AI_Conversation.php',
    'Test_AIPS_AI_Edit_Controller' => $baseDir . '/tests/Test_AIPS_AI_Edit_Controller.php',
    'Test_AIPS_AI_Provider_Factory' => $baseDir . '/tests/Test_AIPS_AI_Provider_Factory.php',
    'Test_AIPS_AI_Service' => $baseDir . '/tests/Test_AIPS_AI_Service.php',
    'Test_AIPS_AI_Service_With_Provider' => $baseDir . '/tests/Test_AIPS_AI_Service_With_Provider.php',
    ...
    'Test_AIPS_Author_Topic_Auto_Approval' => $baseDir . '/tests/Test_AIPS_Author_Topic_Auto_Approval.php',
    'Test_AIPS_Batch_Queue_Service' => $baseDir . '/tests/Test_AIPS_Batch_Queue_Service.php',
    ...
    'Test_AIPS_Cache' => $baseDir . '/tests/Test_AIPS_Cache.php',
    'Test_AIPS_Cache_Array_Driver' => $baseDir . '/tests/Test_AIPS_Cache_Array_Driver.php',
    'Test_AIPS_Cache_Db_Driver' => $baseDir . '/tests/Test_AIPS_Cache_Db_Driver.php',
    'Test_AIPS_Cache_Disabled' => $baseDir . '/tests/Test_AIPS_Cache_Disabled.php',
    'Test_AIPS_Cache_Factory' => $baseDir . '/tests/Test_AIPS_Cache_Factory.php',
    'Test_AIPS_Cache_Factory_Disabled' => $baseDir . '/tests/Test_AIPS_Cache_Factory_Disabled.php',
    'Test_AIPS_Cache_Factory_Named' => $baseDir . '/tests/Test_AIPS_Cache_Factory_Named.php',
    'Test_AIPS_Cache_Factory_Named_Guard' => $baseDir . '/tests/Test_AIPS_Cache_Factory_Named_Guard.php',
    'Test_AIPS_Cache_Wp_Object_Cache_Driver' => $baseDir . '/tests/Test_AIPS_Cache_Wp_Object_Cache_Driver.php',
    'Test_AIPS_Cacheable_Repository' => $baseDir . '/tests/Test_AIPS_Cacheable_Repository.php',
    ...
    'Test_AIPS_Campaigns_Controller' => $baseDir . '/tests/Test_AIPS_Campaigns_Controller.php',
    ...
    'Test_AIPS_Content_Auditor_Controller' => $baseDir . '/tests/Test_AIPS_Content_Auditor_Controller.php',
    'Test_AIPS_Content_Auditor_Engine' => $baseDir . '/tests/Test_AIPS_Content_Auditor_Engine.php',
    'Test_AIPS_Content_Auditor_JSON_Parsing' => $baseDir . '/tests/Test_AIPS_Content_Auditor_JSON_Parsing.php',
    'Test_AIPS_Content_Auditor_Repository' => $baseDir . '/tests/Test_AIPS_Content_Auditor_Repository.php',
    'Test_AIPS_Content_Auditor_Scanner' => $baseDir . '/tests/Test_AIPS_Content_Auditor_Scanner.php',
    'Test_AIPS_Content_Digest' => $baseDir . '/tests/Test_AIPS_Content_Digest.php',
    'Test_AIPS_Content_Indexer_Controller' => $baseDir . '/tests/Test_AIPS_Content_Indexer_Controller.php',
    'Test_AIPS_Content_Indexer_Service' => $baseDir . '/tests/Test_AIPS_Content_Indexer_Service.php',
    ...
    'Test_AIPS_DB_Migrations' => $baseDir . '/tests/Test_AIPS_DB_Migrations.php',
    ...
    'Test_AIPS_Date_Time' => $baseDir . '/tests/Test_AIPS_Date_Time.php',
    'Test_AIPS_Date_Time_DB_Repair' => $baseDir . '/tests/Test_AIPS_Date_Time_DB_Repair.php',
    'Test_AIPS_Deduplication_Service' => $baseDir . '/tests/Test_AIPS_Deduplication_Service.php',
    'Test_AIPS_Diagnostics_Embedded_Templates' => $baseDir . '/tests/Test_AIPS_Diagnostics_Embedded_Templates.php',
    'Test_AIPS_Embeddings_Repository' => $baseDir . '/tests/Test_AIPS_Embeddings_Repository.php',
    ...
    'Test_AIPS_Generator_Content_Cleanup' => $baseDir . '/tests/Test_AIPS_Generator_Content_Cleanup.php',
    'Test_AIPS_Generator_Conversational' => $baseDir . '/tests/Test_AIPS_Generator_Conversational.php',
    'Test_AIPS_Generator_Required_Content' => $baseDir . '/tests/Test_AIPS_Generator_Required_Content.php',
    'Test_AIPS_History_Creation_Method_Length' => $baseDir . '/tests/Test_AIPS_History_Creation_Method_Length.php',
    'Test_AIPS_History_Event_Contract' => $baseDir . '/tests/Test_AIPS_History_Event_Contract.php',
    'Test_AIPS_History_Event_Indexed_Columns' => $baseDir . '/tests/Test_AIPS_History_Event_Indexed_Columns.php',
    'Test_AIPS_History_Grouping' => $baseDir . '/tests/Test_AIPS_History_Grouping.php',
    'Test_AIPS_History_Query_Service' => $baseDir . '/tests/Test_AIPS_History_Query_Service.php',
    ...
    'Test_AIPS_Integration_ACF' => $baseDir . '/tests/Test_AIPS_Integration_ACF.php',
    'Test_AIPS_Integration_Manager' => $baseDir . '/tests/Test_AIPS_Integration_Manager.php',
    'Test_AIPS_Integration_Native_Meta' => $baseDir . '/tests/Test_AIPS_Integration_Native_Meta.php',
    'Test_AIPS_Integration_Registry' => $baseDir . '/tests/Test_AIPS_Integration_Registry.php',
    'Test_AIPS_Integrations_Controller' => $baseDir . '/tests/Test_AIPS_Integrations_Controller.php',
    ...
    'Test_AIPS_JSON_Extractor' => $baseDir . '/tests/Test_AIPS_JSON_Extractor.php',
    'Test_AIPS_Job_Dispatcher' => $baseDir . '/tests/Test_AIPS_Job_Dispatcher.php',
    'Test_AIPS_Job_Scheduler' => $baseDir . '/tests/Test_AIPS_Job_Scheduler.php',
    ...
    'Test_AIPS_Meow_AI_Provider' => $baseDir . '/tests/Test_AIPS_Meow_AI_Provider.php',
    ...
    'Test_AIPS_Post_History_UI' => $baseDir . '/tests/Test_AIPS_Post_History_UI.php',
    ...
    'Test_AIPS_Provider_Availability' => $baseDir . '/tests/Test_AIPS_Provider_Availability.php',
    'Test_AIPS_Recording_Container' => $baseDir . '/tests/Test_AIPS_History_Event_Contract.php',
    'Test_AIPS_Related_Posts_Service' => $baseDir . '/tests/Test_AIPS_Related_Posts_Service.php',
    'Test_AIPS_Relationships_Repository' => $baseDir . '/tests/Test_AIPS_Relationships_Repository.php',
    'Test_AIPS_Repository_Cache_Config' => $baseDir . '/tests/Test_AIPS_Repository_Cache_Config.php',
    'Test_AIPS_Repository_Cache_Dependencies' => $baseDir . '/tests/Test_AIPS_Repository_Cache_Dependencies.php',
    'Test_AIPS_Repository_Cache_Key_Builder' => $baseDir . '/tests/Test_AIPS_Repository_Cache_Key_Builder.php',
    'Test_AIPS_Repository_Cache_Observer' => $baseDir . '/tests/Test_AIPS_Repository_Cache_Observer.php',
    'Test_AIPS_Repository_Insert_Id' => $baseDir . '/tests/Test_AIPS_Repository_Insert_Id.php',
    'Test_AIPS_Resilience_Improvements' => $baseDir . '/tests/Test_AIPS_Resilience_Improvements.php',
    'Test_AIPS_Resilience_Service' => $baseDir . '/tests/Test_AIPS_Resilience_Service.php',
    'Test_AIPS_Schedule_Batch_Resume_Service' => $baseDir . '/tests/Test_AIPS_Schedule_Batch_Resume_Service.php',
    ...
    'Test_AIPS_Schedule_Processor_Global_AI_Disable' => $baseDir . '/tests/Test_AIPS_Schedule_Processor_Global_AI_Disable.php',
    'Test_AIPS_Schedule_Repository_Bulk' => $baseDir . '/tests/Test_AIPS_Schedule_Repository_Bulk.php',
    'Test_AIPS_Schedule_Timing_Drift' => $baseDir . '/tests/Test_AIPS_Schedule_Timing_Drift.php',
    ...
    'Test_AIPS_Settings_Ajax' => $baseDir . '/tests/Test_AIPS_Settings_Ajax.php',
    'Test_AIPS_Settings_Ajax_Fake_AI_Service' => $baseDir . '/tests/Test_AIPS_Settings_Ajax.php',
    'Test_AIPS_Settings_Ajax_Fake_History_Container' => $baseDir . '/tests/Test_AIPS_Settings_Ajax.php',
    'Test_AIPS_Settings_Ajax_Fake_History_Service' => $baseDir . '/tests/Test_AIPS_Settings_Ajax.php',
    'Test_AIPS_Settings_Global_AI_Disable' => $baseDir . '/tests/Test_AIPS_Settings_Global_AI_Disable.php',
    'Test_AIPS_Settings_UI_Cache_Driver' => $baseDir . '/tests/Test_AIPS_Settings_UI_Cache_Driver.php',
    ...
    'Test_AIPS_Stress_Test_Service' => $baseDir . '/tests/Test_AIPS_Stress_Test_Service.php',
    'Test_AIPS_System_Diagnostics_Service' => $baseDir . '/tests/Test_AIPS_System_Diagnostics_Service.php',
    'Test_AIPS_System_Status' => $baseDir . '/tests/Test_AIPS_System_Status.php',
    'Test_AIPS_System_Status_Controller' => $baseDir . '/tests/Test_AIPS_System_Status_Controller.php',
    'Test_AIPS_System_Status_Diagnostics_Service' => $baseDir . '/tests/Test_AIPS_System_Status_Diagnostics_Service.php',
    ...
    'Test_AIPS_Template_Entry' => $baseDir . '/tests/Test_AIPS_Generation_Result.php',
    'Test_AIPS_Template_Processor' => $baseDir . '/tests/Test_AIPS_Template_Processor.php',
    'Test_AIPS_Template_Repository_Post_Type' => $baseDir . '/tests/Test_AIPS_Template_Repository_Post_Type.php',
    'Test_AIPS_Templates_Controller_Clone' => $baseDir . '/tests/Test_AIPS_Templates_Controller_Clone.php',
    ...
    'Test_AIPS_Templates_Pending_Stats' => $baseDir . '/tests/Test_AIPS_Templates_Pending_Stats.php',
    'Test_AIPS_Token_Budget' => $baseDir . '/tests/Test_AIPS_Token_Budget.php',
    'Test_AIPS_Upgrades' => $baseDir . '/tests/Test_AIPS_Upgrades.php',
    'Test_AIPS_Utilities_Post_Types' => $baseDir . '/tests/Test_AIPS_Utilities_Post_Types.php',
    'Test_AIPS_WP_AI_Client_Provider' => $baseDir . '/tests/Test_AIPS_WP_AI_Client_Provider.php',
    ...
    'Test_Author_Topics_Repository_Cache' => $baseDir . '/tests/Test_Template_Repository_Cache.php',
    ...
    'Test_Prompt_Builder_Diversity_Injector' => $baseDir . '/tests/Test_Prompt_Builder_Diversity_Injector.php',
    ...
    'Test_Prompt_Builder_Post_Metadata' => $baseDir . '/tests/Test_Prompt_Builder_Post_Metadata.php',
    ...
    'Test_Prompt_Builder_Topic' => $baseDir . '/tests/Test_Prompt_Builder_Topic.php',
