...
return array(
    ...
    'AIPS_Article_Structure_Repository_Test' => $baseDir . '/tests/test-article-structure-repository.php',
    ...
    'AIPS_Author_Topics_Bulk_Actions_Test' => $baseDir . '/tests/test-author-topics-bulk-actions.php',
    ...
    'AIPS_Feedback_Repository_Test' => $baseDir . '/tests/test-feedback-repository.php',
    ...
    'AIPS_History_Repository_Performance_Test' => $baseDir . '/tests/test-history-repository-performance.php',
    'AIPS_History_Repository_Test' => $baseDir . '/tests/test-history-repository.php',
    ...
    'AIPS_Onboarding_Wizard_Test' => $baseDir . '/tests/test-onboarding-wizard.php',
    ...
    'AIPS_Post_Creator_SEO_Test' => $baseDir . '/tests/test-post-creator-seo.php',
    ...
    'AIPS_Post_Manager_SEO_Metadata_Test' => $baseDir . '/tests/test-post-manager-seo.php',
    ...
    'AIPS_Prompt_Template_Defaults' => $baseDir . '/includes/class-aips-prompt-template-defaults.php',
    'AIPS_Prompt_Template_Group_Repository' => $baseDir . '/includes/class-aips-prompt-template-group-repository.php',
    'AIPS_Prompt_Template_Item_Repository' => $baseDir . '/includes/class-aips-prompt-template-item-repository.php',
    ...
    'AIPS_Structures_Controller_Test' => $baseDir . '/tests/test-structures-controller.php',
    ...
    'AIPS_Template_Type_Selector_Test' => $baseDir . '/tests/test-template-type-selector.php',
    ...
    'AIPS_Test_History_Container' => $baseDir . '/tests/test-notifications.php',
    'AIPS_Test_History_Service' => $baseDir . '/tests/test-notifications.php',
    'AIPS_Test_Notifications_Repository' => $baseDir . '/tests/test-notifications.php',
    'AIPS_Test_Stub_AI_Service_For_Feedback' => $baseDir . '/tests/test-author-topics-generator-feedback-guidance.php',
    'AIPS_Test_Stub_AI_Service_For_Fuzzy' => $baseDir . '/tests/test-author-topics-generator-fuzzy-duplicates.php',
    'AIPS_Test_Stub_AI_Service_For_Prompt_Builder' => $baseDir . '/tests/test-prompt-builder.php',
    'AIPS_Test_Stub_AI_Service_For_Suggestions' => $baseDir . '/tests/test-author-suggestions-service.php',
    'AIPS_Test_Stub_History_Container_For_Suggestions' => $baseDir . '/tests/test-author-suggestions-service.php',
    'AIPS_Test_Stub_History_Repository_For_Correlation' => $baseDir . '/tests/test-correlation-id.php',
    'AIPS_Test_Stub_History_Service_For_Suggestions' => $baseDir . '/tests/test-author-suggestions-service.php',
    'AIPS_Test_Stub_Logger_For_Feedback' => $baseDir . '/tests/test-author-topics-generator-feedback-guidance.php',
    'AIPS_Test_Stub_Logger_For_Fuzzy' => $baseDir . '/tests/test-author-topics-generator-fuzzy-duplicates.php',
    'AIPS_Test_Stub_Logger_For_Suggestions' => $baseDir . '/tests/test-author-suggestions-service.php',
    'AIPS_Test_Templates_Save_Stub' => $baseDir . '/tests/test-templates-controller-save.php',
    ...
    'AIPS_Topic_Penalty_Service_Test' => $baseDir . '/tests/test-topic-penalty-service.php',
    ...
    'AIPS_Voices_Repository_Test' => $baseDir . '/tests/test-voices-repository.php',
    ...
    'Mock_WPDB_Query_Counter' => $baseDir . '/tests/test-repository-identity-map-cache.php',
    'Mock_WPDB_Stateful_Voices' => $baseDir . '/tests/test-voices-repository.php',
    ...
    'Test_AIPS_AI_Edit_Controller' => $baseDir . '/tests/test-ai-edit-controller.php',
    'Test_AIPS_AI_Service' => $baseDir . '/tests/test-ai-service.php',
    'Test_AIPS_Admin_Bar_Cache' => $baseDir . '/tests/test-admin-bar-cache.php',
    'Test_AIPS_Admin_Menu' => $baseDir . '/tests/test-admin-menu.php',
    'Test_AIPS_Ajax_Registry_Response' => $baseDir . '/tests/test-ajax-registry-response.php',
    'Test_AIPS_Author_Post_Generator_Expansion' => $baseDir . '/tests/test-author-post-generator-expansion.php',
    'Test_AIPS_Bulk_Generator_Service' => $baseDir . '/tests/test-bulk-generator-service.php',
    'Test_AIPS_Cache' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Array_Driver' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Db_Driver' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Factory' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Factory_Named' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Factory_Named_Guard' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Redis_Driver' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Session_Driver' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Cache_Wp_Object_Cache_Driver' => $baseDir . '/tests/test-cache.php',
    'Test_AIPS_Calendar_Controller' => $baseDir . '/tests/test-calendar-controller.php',
    'Test_AIPS_Config' => $baseDir . '/tests/test-config.php',
    'Test_AIPS_Config_Option_Cache' => $baseDir . '/tests/test-config-option-cache.php',
    'Test_AIPS_Container' => $baseDir . '/tests/test-container.php',
    'Test_AIPS_Container_Bindings' => $baseDir . '/tests/test-container-bindings.php',
    'Test_AIPS_Context_Boot' => $baseDir . '/tests/test-context-boot.php',
    'Test_AIPS_Correlation_ID' => $baseDir . '/tests/test-correlation-id.php',
    'Test_AIPS_DB_Schema' => $baseDir . '/tests/test-db-schema.php',
    'Test_AIPS_Generate_Now_Timing' => $baseDir . '/tests/test-generate-now-timing.php',
    'Test_AIPS_Generation_Context' => $baseDir . '/tests/Test_AIPS_Generation_Context.php',
    'Test_AIPS_Generation_Logger' => $baseDir . '/tests/test-generation-logger.php',
    'Test_AIPS_Generation_Result' => $baseDir . '/tests/test-typed-dtos.php',
    'Test_AIPS_History_Security' => $baseDir . '/tests/test-security-history.php',
    'Test_AIPS_Image_Service' => $baseDir . '/tests/test-image-service.php',
    'Test_AIPS_Image_Service_Collision' => $baseDir . '/tests/test-image-service-collision.php',
    'Test_AIPS_Internal_Link_Inserter_Service' => $baseDir . '/tests/test-internal-link-inserter-service.php',
    'Test_AIPS_Internal_Links' => $baseDir . '/tests/test-internal-links.php',
    'Test_AIPS_Interval_Calculator' => $baseDir . '/tests/test-interval-calculator.php',
    'Test_AIPS_Logger_Performance' => $baseDir . '/tests/test-logger-performance.php',
    'Test_AIPS_Manual_Schedule_Execution' => $baseDir . '/tests/test-manual-schedule-execution.php',
    'Test_AIPS_Markdown_Parser' => $baseDir . '/tests/test-aips-markdown-parser.php',
    'Test_AIPS_Metrics_Repository' => $baseDir . '/tests/test-metrics-repository.php',
    'Test_AIPS_Mock_Scheduler' => $baseDir . '/tests/test-bulk-schedule.php',
    'Test_AIPS_Notification_Registry' => $baseDir . '/tests/test-notification-registry.php',
    'Test_AIPS_Notification_Senders' => $baseDir . '/tests/test-notification-senders.php',
    'Test_AIPS_Notification_Template' => $baseDir . '/tests/test-notifications.php',
    'Test_AIPS_Notification_Templates' => $baseDir . '/tests/test-notifications.php',
    'Test_AIPS_Notifications' => $baseDir . '/tests/test-notifications-repository.php',
    'Test_AIPS_Notifications_Service' => $baseDir . '/tests/test-notifications.php',
    'Test_AIPS_Planner_BulkSchedule' => $baseDir . '/tests/test-bulk-schedule.php',
    'Test_AIPS_Planner_Bulk_Generate_Now' => $baseDir . '/tests/test-planner-bulk-generate-now.php',
    'Test_AIPS_Planner_Testable' => $baseDir . '/tests/test-planner-bulk-generate-now.php',
    'Test_AIPS_Post_Review_Repository' => $baseDir . '/tests/test-post-review-repository.php',
    'Test_AIPS_Prompt_Builder' => $baseDir . '/tests/test-prompt-builder.php',
    'Test_AIPS_Prompt_Template_Defaults' => $baseDir . '/tests/Test_AIPS_Prompt_Template_Defaults.php',
    'Test_AIPS_Prompt_Template_Group_Repository' => $baseDir . '/tests/Test_AIPS_Prompt_Template_Group_Repository.php',
    'Test_AIPS_Prompt_Template_Item_Repository' => $baseDir . '/tests/Test_AIPS_Prompt_Template_Item_Repository.php',
    'Test_AIPS_Resilience_Improvements' => $baseDir . '/tests/test-resilience-improvements.php',
    'Test_AIPS_Schedule_Controller_Bulk' => $baseDir . '/tests/test-schedule-controller-bulk.php',
    'Test_AIPS_Schedule_Controller_Run_Now' => $baseDir . '/tests/test-schedule-controller-run-now.php',
    'Test_AIPS_Schedule_Controller_Save' => $baseDir . '/tests/test-schedule-controller-save.php',
    'Test_AIPS_Schedule_Entry' => $baseDir . '/tests/test-typed-dtos.php',
    'Test_AIPS_Schedule_History' => $baseDir . '/tests/test-schedule-history.php',
    'Test_AIPS_Schedule_Repository_Bulk' => $baseDir . '/tests/test-schedule-repository-bulk.php',
    'Test_AIPS_Scheduler_Hook_Registration' => $baseDir . '/tests/test-scheduler-hook-registration.php',
    'Test_AIPS_Scheduler_Resilience' => $baseDir . '/tests/test-scheduler-resilience.php',
    'Test_AIPS_Scheduler_Save' => $baseDir . '/tests/test-scheduler-save.php',
    'Test_AIPS_Singleton_Instances' => $baseDir . '/tests/test-singleton-instances.php',
    'Test_AIPS_Site_Context' => $baseDir . '/tests/test-site-context.php',
    'Test_AIPS_Sources' => $baseDir . '/tests/test-sources.php',
    'Test_AIPS_Sources_Data_Repository' => $baseDir . '/tests/test-sources-data-repository.php',
    'Test_AIPS_Sources_Fetcher' => $baseDir . '/tests/test-sources-fetcher.php',
    'Test_AIPS_System_Diagnostics_Service' => $baseDir . '/tests/test-aips-system-diagnostics-service.php',
    'Test_AIPS_Telemetry' => $baseDir . '/tests/test-telemetry.php',
    'Test_AIPS_Template_Data' => $baseDir . '/tests/test-typed-dtos.php',
    'Test_AIPS_Template_Processor' => $baseDir . '/tests/test-template-processor.php',
    'Test_AIPS_Templates_Controller_Preview' => $baseDir . '/tests/test-templates-controller-preview.php',
    'Test_AIPS_Templates_Controller_Save' => $baseDir . '/tests/test-templates-controller-save.php',
    'Test_AIPS_Templates_Interval' => $baseDir . '/tests/test-templates-interval.php',
    'Test_AIPS_Token_Budget' => $baseDir . '/tests/test-token-budget.php',
    'Test_AIPS_Upgrades' => $baseDir . '/tests/test-upgrades.php',
    'Test_Article_Structure_Repository_Cache' => $baseDir . '/tests/test-repository-identity-map-cache.php',
    'Test_Author_Suggestions_Service' => $baseDir . '/tests/test-author-suggestions-service.php',
    'Test_Author_Topics_Controller_Delegation' => $baseDir . '/tests/test-author-topics-controller-delegation.php',
    'Test_Author_Topics_Generator_Feedback_Guidance' => $baseDir . '/tests/test-author-topics-generator-feedback-guidance.php',
    'Test_Author_Topics_Generator_Fuzzy_Duplicates' => $baseDir . '/tests/test-author-topics-generator-fuzzy-duplicates.php',
    'Test_Authors_Repository_Cache' => $baseDir . '/tests/test-repository-identity-map-cache.php',
    'Test_Bug_Hunter_Filesystem_Errors' => $baseDir . '/tests/test-bug-hunter-filesystem-errors.php',
    'Test_Bug_Hunter_JSON_Errors' => $baseDir . '/tests/test-bug-hunter-json-errors.php',
    'Test_Bulk_Schedule' => $baseDir . '/tests/test-bulk-schedule.php',
    'Test_Component_Regeneration_Service' => $baseDir . '/tests/test-component-regeneration-service.php',
    'Test_Generated_Posts_Controller' => $baseDir . '/tests/test-generated-posts-controller.php',
    'Test_Generation_Queue' => $baseDir . '/tests/test-generation-queue.php',
    'Test_History_Template' => $baseDir . '/tests/test-history-template.php',
    'Test_N_Plus_One' => $baseDir . '/tests/test-n-plus-one.php',
    'Test_Partial_Generation_State_Reconciler' => $baseDir . '/tests/test-partial-generation-state-reconciler.php',
    'Test_Prompt_Builder_Authors' => $baseDir . '/tests/test-prompt-builder-authors.php',
    'Test_Prompt_Builder_Post_Content' => $baseDir . '/tests/test-prompt-builder-post-content.php',
    'Test_Prompt_Builder_Post_Excerpt' => $baseDir . '/tests/test-prompt-builder-post-excerpt.php',
    'Test_Prompt_Builder_Post_Featured_Image' => $baseDir . '/tests/test-prompt-builder-post-featured-image.php',
    'Test_Prompt_Builder_Post_Title' => $baseDir . '/tests/test-prompt-builder-post-title.php',
    'Test_Prompt_Builder_Taxonomy' => $baseDir . '/tests/test-prompt-builder-taxonomy.php',
    'Test_Prompt_Section_Repository_Cache' => $baseDir . '/tests/test-repository-identity-map-cache.php',
    'Test_Query_Collision' => $baseDir . '/tests/test-query-collision.php',
    'Test_Research_Service' => $baseDir . '/tests/test-research-service.php',
    'Test_Schedule_Repository_Cache' => $baseDir . '/tests/test-repository-identity-map-cache.php',
    'Test_Schedule_Result_Handler' => $baseDir . '/tests/test-schedule-result-handler.php',
    'Test_Session_To_JSON' => $baseDir . '/tests/test-session-to-json.php',
    'Test_Stub_History_Container' => $baseDir . '/tests/test-bulk-generator-service.php',
    'Test_Stub_History_Service' => $baseDir . '/tests/test-bulk-generator-service.php',
    'Test_Template_Repository_Cache' => $baseDir . '/tests/test-repository-identity-map-cache.php',
    'Test_Topic_Posts_View' => $baseDir . '/tests/test-topic-posts-view.php',
    'Test_Trending_Topics_Repository' => $baseDir . '/tests/test-trending-topics-repository.php',
    'Test_Voices_Repository_Cache' => $baseDir . '/tests/test-repository-identity-map-cache.php',
