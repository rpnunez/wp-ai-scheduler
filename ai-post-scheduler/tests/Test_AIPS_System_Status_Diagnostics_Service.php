...
class Test_AIPS_System_Status_Diagnostics_Service extends WP_UnitTestCase {
	...
	public function test_get_system_info_aggregates_from_providers() {
		...
		$service = new AIPS_System_Status_Diagnostics_Service( array( $mock_provider ) );
	...
	public function test_add_provider_appends_to_provider_list() {
		...
		$service = new AIPS_System_Status_Diagnostics_Service( array( $first_provider ) );
	...
	public function test_custom_provider_keys_are_not_silently_dropped() {
		...
		$service = new AIPS_System_Status_Diagnostics_Service( array( $custom_provider ) );
		$info    = $service->get_system_info();
	...
	public function test_expected_keys_are_ordered_before_custom_keys() {
		...
		$service = new AIPS_System_Status_Diagnostics_Service( array( $custom_provider, $environment_provider ) );
		$info    = $service->get_system_info();
	...
	public function test_empty_providers_returns_empty_array() {
		$service = new AIPS_System_Status_Diagnostics_Service( array() );
		$info    = $service->get_system_info();
