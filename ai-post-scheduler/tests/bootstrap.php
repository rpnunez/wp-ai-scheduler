...
if (file_exists(WP_TESTS_DIR . '/includes/functions.php')) {
    ...
    $files = [
        ...
        'repositories/class-aips-trending-topics-repository.php',
        'repositories/class-aips-history-repository.php',
        'repositories/class-aips-schedule-repository.php',
        'repositories/class-aips-template-repository.php',
        'repositories/class-aips-article-structure-repository.php',
        'repositories/class-aips-prompt-section-repository.php',
        'repositories/class-aips-sources-repository.php',
        ...
        'services/class-aips-resilience-service.php',
        'services/class-aips-ai-service.php',
        'services/class-aips-image-service.php',
        'services/class-aips-research-service.php',
        ...
        'services/class-aips-component-regeneration-service.php',
        'controllers/class-aips-ai-edit-controller.php',
        ...
        'repositories/class-aips-notifications-repository.php',
        ...
        'controllers/class-aips-calendar-controller.php',
        'class-aips-system-status.php',
        'class-aips-templates.php',
        'class-aips-upgrades.php',
        'repositories/class-aips-post-review-repository.php',
        'repositories/class-aips-voices-repository.php',
        'class-aips-voices.php',
        'controllers/class-aips-structures-controller.php',
        'controllers/class-aips-templates-controller.php',
        'controllers/class-aips-research-controller.php',
        'controllers/class-aips-sources-controller.php',
        // Author-related classes
        'repositories/class-aips-authors-repository.php',
        'repositories/class-aips-author-topics-repository.php',
        'repositories/class-aips-author-topic-logs-repository.php',
        'repositories/class-aips-feedback-repository.php',
        'services/class-aips-topic-penalty-service.php',
        'services/class-aips-embeddings-service.php',
        'services/class-aips-topic-expansion-service.php',
        'class-aips-site-context.php',
        'class-aips-author-topics-generator.php',
        'class-aips-author-topics-scheduler.php',
        'controllers/class-aips-authors-controller.php',
        'class-aips-author-post-generator.php',
        'controllers/class-aips-author-topics-controller.php',
        'services/class-aips-author-suggestions-service.php',
        'repositories/class-aips-metrics-repository.php',
    ];
