...
if (file_exists(WP_TESTS_DIR . '/includes/functions.php')) {
    ...
    if (!function_exists('current_user_can')) {
        function current_user_can($capability) {
            ...
            if ($role === 'administrator' && ($capability === 'manage_options' || $capability === 'edit_posts')) {
                return true;
            }
            return false;
        }
	...
	// Register autoloader and compatibility loader
	require_once $includes_dir . 'class-aips-autoloader.php';
	AIPS_Autoloader::register();
	require_once $includes_dir . 'compatibility-loader.php';
