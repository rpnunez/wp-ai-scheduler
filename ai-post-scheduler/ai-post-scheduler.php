...
final class AI_Post_Scheduler {
    ...
    private function includes() {
        ...
        require_once AIPS_PLUGIN_DIR . 'includes/class-aips-queue-controller.php';
        require_once AIPS_PLUGIN_DIR . 'includes/class-aips-calendar-controller.php';
