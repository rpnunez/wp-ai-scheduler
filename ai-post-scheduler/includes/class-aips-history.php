...
class AIPS_History {
    ...
    public function ajax_reload_history() {
        ...
        // Include the history rows template which iterates over $history['items']
        if (file_exists(AIPS_PLUGIN_DIR . 'templates/admin/history-rows.php')) {
            include AIPS_PLUGIN_DIR . 'templates/admin/history-rows.php';
        }
