...
class AIPS_Research_Controller {
    ...
    public function __construct() {
        ...
        $this->research_service       = $container->makeIfExists(AIPS_Research_Service::class);
        $this->repository             = $container->makeIfExists(AIPS_Trending_Topics_Repository::class);
        ...
        $this->content_auditor        = $container->makeIfExists(AIPS_Content_Auditor::class);
