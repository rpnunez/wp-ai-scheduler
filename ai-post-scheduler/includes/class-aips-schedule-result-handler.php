 ...
 *
 * Handles post-execution cleanup, failure, and success logic for schedules.
 * Extracted from AIPS_Schedule_Processor to adhere to Single Responsibility Principle.
 *
...
class AIPS_Schedule_Result_Handler {
     ...
     * @param AIPS_Template_Type_Selector        $template_type_selector
     */
    public function __construct(
        AIPS_Schedule_Repository_Interface $repository,
        AIPS_History_Service_Interface $history_service,
        AIPS_History_Repository_Interface $history_repository,
        AIPS_Logger_Interface $logger,
        AIPS_Template_Type_Selector $template_type_selector
    ) {
        $this->repository             = $repository;
        $this->history_service        = $history_service;
        $this->history_repository     = $history_repository;
        $this->logger                 = $logger;
        $this->template_type_selector = $template_type_selector;
    }
