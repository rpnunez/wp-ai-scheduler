...
class AIPS_Admin_Assets {
    ...
    private function enqueue_history_assets() {
            ...
            wp_localize_script('aips-admin-history', 'aipsHistoryL10n', array(
                ...
                'typeLabels'           => array(
                    1  => __('Log', 'ai-post-scheduler'),
                    2  => __('Error', 'ai-post-scheduler'),
                    3  => __('Warning', 'ai-post-scheduler'),
                    4  => __('Info', 'ai-post-scheduler'),
                    5  => __('AI Request', 'ai-post-scheduler'),
                    6  => __('AI Response', 'ai-post-scheduler'),
                    7  => __('Debug', 'ai-post-scheduler'),
                    8  => __('Activity', 'ai-post-scheduler'),
                    9  => __('Session', 'ai-post-scheduler'),
                    10 => __('Metric', 'ai-post-scheduler'),
                ),
