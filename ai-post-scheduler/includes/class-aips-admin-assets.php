...
class AIPS_Admin_Assets {
    ...
    public function enqueue_admin_assets($hook) {
        ...
        wp_enqueue_script(
            ...
            array('jquery', 'aips-utilities-script', 'wp-i18n'),
            AIPS_VERSION,
            true
        );
        ...
        // Register script translations so wp.i18n.__ picks up .json files from languages/.
        wp_set_script_translations( 'aips-admin-script', 'ai-post-scheduler', AIPS_PLUGIN_DIR . '/languages' );
