...
class AIPS_Authors_Controller {
	...
	public function ajax_save_author() {
		...
		$data = array(
			...
			'manual_post_generation_quantity' => isset($_POST['manual_post_generation_quantity']) ? max(1, absint($_POST['manual_post_generation_quantity'])) : 1,
			'scheduled_post_generation_quantity' => isset($_POST['scheduled_post_generation_quantity']) ? max(1, absint($_POST['scheduled_post_generation_quantity'])) : 1,
			// Source group fields
