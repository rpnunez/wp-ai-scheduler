...
class AIPS_Schedule_Controller {
	...
	public function ajax_get_schedule_status_read_model() {
		...
		$families = array(
			...
			AIPS_Unified_Schedule_Service::TYPE_POST_IMPROVEMENT_SCAN => 'aips_process_post_improvement_scans',
		);
		...
		$queue_hooks = array(
			...
			'aips_process_post_improvement_scans',
	...
	public function ajax_unified_run_now() {
		...
		} elseif ($type === AIPS_Unified_Schedule_Service::TYPE_POST_IMPROVEMENT_SCAN) {
			AIPS_Ajax_Response::success(array(
				'message' => __('Post improvement scan executed successfully.', 'ai-post-scheduler'),
			));
		} else {
