...
$result = $this->repository->get_pending_suggestions(array(
'page' => $page,
'search' => $search,
));
...
AIPS_Ajax_Response::success(array('message' => __('Scan schedule updated.', 'ai-post-scheduler'), 'schedule_id' => $schedule_id));
}
...
AIPS_Ajax_Response::success(array('message' => __('Scan schedule created.', 'ai-post-scheduler'), 'schedule_id' => $new_id));
}
