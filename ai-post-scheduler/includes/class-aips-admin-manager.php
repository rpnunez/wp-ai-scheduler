...
/**
 * Class AIPS_Admin_Manager
 *
 * Handles the registration of admin menu pages, enqueuing assets, and routing
...
class AIPS_Admin_Manager {
     ...
     *
     * Hooks into admin_menu, admin_enqueue_scripts, and wp_ajax actions.
     */
