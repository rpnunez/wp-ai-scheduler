 ...
 *   echo $entry->next_run;          // 1736928000
...
class AIPS_Schedule_Entry {
	...
	/**
	 * Unix timestamp of the last completed run, or null if never run.
	 *
	 * @var int|null
	 */
	 ...
	 * @param int|null    $last_run             Last run Unix timestamp or null.
	 ...
	 *
	 * @param int|null $current_time Optional. Current Unix timestamp. Defaults to now.
	 * @return bool
	 */
