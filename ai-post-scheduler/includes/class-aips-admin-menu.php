...
class AIPS_Admin_Menu {
    ...
    /**
     * @var AIPS_Settings The settings instance containing render callbacks.
     */
    private $settings;

    /**
     * Initialize the admin menu handler.
     *
     * @param AIPS_Settings $settings Instance of AIPS_Settings.
     */
