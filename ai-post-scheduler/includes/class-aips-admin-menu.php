...
class AIPS_Admin_Menu {
    ...
    public function render_schedule_page() {
        // Fallback or Controller if render_page exists
        if (class_exists('AIPS_Schedule_Controller') && method_exists('AIPS_Schedule_Controller', 'render_page')) {
    ...
    public function render_schedule_calendar_page() {
        if (class_exists('AIPS_Calendar_Controller') && method_exists('AIPS_Calendar_Controller', 'render_page')) {
    ...
    public function render_research_page() {
        if (class_exists('AIPS_Research_Controller') && method_exists('AIPS_Research_Controller', 'render_page')) {
    ...
    public function render_authors_page() {
        if (class_exists('AIPS_Authors_Controller') && method_exists('AIPS_Authors_Controller', 'render_page')) {
    ...
    public function render_author_topics_page() {
        if (class_exists('AIPS_Author_Topics_Controller') && method_exists('AIPS_Author_Topics_Controller', 'render_page')) {
    ...
    public function render_structures_page() {
        if (class_exists('AIPS_Structures_Controller') && method_exists('AIPS_Structures_Controller', 'render_page')) {
