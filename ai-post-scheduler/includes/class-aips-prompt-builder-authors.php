...
class AIPS_Prompt_Builder_Authors {
	...
	public function build(array $inputs, $count) {
		...
		$prompt .= "Return a JSON array of exactly {$count} object(s) where each item has: \"name\" (string), \"field_niche\" (string), \"description\" (string), \"details\" (string), \"keywords\" (comma-separated string), \"voice_tone\" (string), \"writing_style\" (string), \"target_audience\" (string), \"expertise_level\" (one of: beginner, intermediate, expert, thought_leader), \"content_goals\" (string), \"preferred_content_length\" (one of: short, medium, long), \"topic_generation_prompt\" (string).";
