	...
	private function get_template_schedules() {
		...
		foreach ($raw as $schedule) {
			...
			$result[] = array(
				...
				'article_structure_id' => isset($schedule->article_structure_id) ? (int) $schedule->article_structure_id : null,
				'rotation_pattern' => isset($schedule->rotation_pattern) ? $schedule->rotation_pattern : null,
