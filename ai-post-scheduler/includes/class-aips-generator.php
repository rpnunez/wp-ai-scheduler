...
class AIPS_Generator {
    ...
    * @param AIPS_History_Service_Interface|null $history_service
    ...
    private function generate_post_from_context($context) {
        ...
        $metadata_result = $this->generate_and_resolve_metadata($context, $content, $component_statuses);
        $title                 = $metadata_result['title'];
        $excerpt               = $metadata_result['excerpt'];
        $resolved_image_prompt = $metadata_result['resolved_image_prompt'];
        $generation_incomplete = $metadata_result['generation_incomplete'];
        $pre_image_incomplete  = $metadata_result['pre_image_incomplete'];
     ...
     * @param array $component_statuses
     * @param float $generation_start
    ...
    /**
     * Generates and resolves metadata (title, excerpt, variables).
     *
     * @param AIPS_Generation_Context $context
     ...
     * @return array
     */
    private function generate_and_resolve_metadata($context, &$content, &$component_statuses) {
        ...
        return array(
            ...
            'generation_incomplete' => $generation_incomplete,
            'pre_image_incomplete' => $pre_image_incomplete,
        );
    }
}
