...
class AIPS_Generator {
    ...
    public function __construct(
        ...
        $this->variable_resolution_service = $variable_resolution_service ?: new AIPS_Variable_Resolution_Service($this->ai_service, $this->logger, $this->template_processor);
    }
    ...
    public function resolve_ai_variables($template, $content, $voice = null) {
        return $this->variable_resolution_service->resolve_ai_variables($template, $content, $voice);
    }
    ...
    private function generate_post_from_context($context) {
        ...
        $ai_variables = $this->variable_resolution_service->resolve_ai_variables_from_context($context, $content);
