...
class AIPS_Generator {
    ...
    /**
     * @var AIPS_Variable_Resolution_Service Service for variable resolution
     */
    private $variable_resolution_service;
     ...
     * @param object|null $variable_resolution_service
     */
    public function __construct(
        ...
        $prompt_builder = null,
        $variable_resolution_service = null
    ) {
        ...
        $this->variable_resolution_service = $variable_resolution_service ?: new AIPS_Variable_Resolution_Service($this->template_processor, $this->ai_service, $this->logger);
    }
    ...
    public function resolve_ai_variables($template, $content, $voice = null) {
        return $this->variable_resolution_service->resolve_ai_variables($template, $content, $voice, $this->current_history);
    }
    ...
    private function resolve_ai_variables_from_context($context, $content) {
        return $this->variable_resolution_service->resolve_ai_variables_from_context($context, $content, $this->current_history);
    }
