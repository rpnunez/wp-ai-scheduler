...
class AIPS_Generator {
    ...
    /**
     * @var AIPS_AI_Variables_Resolver AI Variables resolver
     */
    private $ai_variables_resolver;
    ...
    * @param AIPS_History_Service_Interface|null $history_service
    ...
    public function __construct(
        ...
        // Initialize AI Variables Resolver
        $this->ai_variables_resolver = new AIPS_AI_Variables_Resolver(
            $this->template_processor,
            array($this, 'generate_content'),
    ...
    public function resolve_ai_variables($template, $content, $voice = null) {
        return $this->ai_variables_resolver->resolve($template, $content, $voice);
    }
    ...
    private function resolve_ai_variables_from_context($context, $content) {
        return $this->ai_variables_resolver->resolve_from_context($context, $content);
    }
