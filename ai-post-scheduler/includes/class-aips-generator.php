...
class AIPS_Generator {
     ...
     * @param object|null $variable_resolver
     */
    public function __construct(
        ...
        $this->variable_resolver = $variable_resolver ?: new AIPS_Variable_Resolution_Service($this->logger, $this->ai_service, $this->template_processor);
    }
    ...
    public function resolve_ai_variables($template, $content, $voice = null) {
        ...
        return $this->variable_resolver->resolve_variables($context, $content, $this->current_history);
    }
    ...
    private function generate_post_from_context($context) {
        ...
        $ai_variables = $this->variable_resolver->resolve_variables($context, $content, $this->current_history);
