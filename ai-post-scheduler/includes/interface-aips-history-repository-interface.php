...
interface AIPS_History_Repository_Interface {
	...
	/**
	 * Fetch schedules run count in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	 * @return int
	...
	/**
	 * Fetch AI calls and errors in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	 * @return object
	...
	/**
	 * Fetch recent posts in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	...
	/**
	 * Fetch posts generated by topic in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	 * @param int $limit Max rows.
	...
	/**
	 * Fetch executed schedules in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	 * @param int $limit Max rows.
	...
	/**
	 * Fetch daily generation stats in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	 * @return array
	...
	/**
	 * Fetch daily AI stats in a period.
	 *
	 * @param int $from_ts Start timestamp.
	 * @param int $to_ts End timestamp.
	 * @return array
