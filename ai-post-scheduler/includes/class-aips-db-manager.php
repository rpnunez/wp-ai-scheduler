...
class AIPS_DB_Manager {
    ...
    public function get_schema() {
		...
		$sql = array_merge( $sql, $this->get_core_schema( $tables, $charset_collate ) );
		...
		$sql = array_merge( $sql, $this->get_metrics_schema( $tables, $charset_collate ) );
		$sql = array_merge( $sql, $this->get_advanced_schema( $tables, $charset_collate ) );
		$sql = array_merge( $sql, $this->get_caching_schema( $tables, $charset_collate ) );

        return $sql;
    }

	/**
	 * Get schema definitions for core tables.
	 *
	 * @param array  $tables Array of resolved table names.
	 * @param string $charset_collate Charset and collate string.
	 * @return array Array of SQL statements.
	 */
	private function get_core_schema( array $tables, string $charset_collate ): array {
		$sql = array();
	...
	/**
	 * Get schema definitions for content tables.
	 *
	 * @param array  $tables Array of resolved table names.
	 * @param string $charset_collate Charset and collate string.
	 * @return array Array of SQL statements.
	...
	/**
	 * Get schema definitions for taxonomy tables.
	 *
	 * @param array  $tables Array of resolved table names.
	 * @param string $charset_collate Charset and collate string.
	 * @return array Array of SQL statements.
	...
	/**
	 * Get schema definitions for metrics tables.
	 *
	 * @param array  $tables Array of resolved table names.
	 * @param string $charset_collate Charset and collate string.
	 * @return array Array of SQL statements.
	 */
	private function get_metrics_schema( array $tables, string $charset_collate ): array {
		$sql = array();
	...
	/**
	 * Get schema definitions for advanced tables.
	 *
	 * @param array  $tables Array of resolved table names.
	 * @param string $charset_collate Charset and collate string.
	 * @return array Array of SQL statements.
	 */
	private function get_advanced_schema( array $tables, string $charset_collate ): array {
		$sql = array();
	...
	/**
	 * Get schema definitions for caching tables.
	 *
	 * @param array  $tables Array of resolved table names.
	 * @param string $charset_collate Charset and collate string.
	 * @return array Array of SQL statements.
	 */
	private function get_caching_schema( array $tables, string $charset_collate ): array {
		$sql = array();
