...
class AIPS_DB_Manager {
    ...
    public function get_schema() {
        ...
        $sql[] = "CREATE TABLE $table_schedule (
            ...
            embargo_until datetime DEFAULT NULL,
            publish_deadline datetime DEFAULT NULL,
            event_name varchar(255) DEFAULT NULL,
            event_type varchar(50) DEFAULT 'recurring',
            prewrite_enabled tinyint(1) DEFAULT 0,
            ready_to_release tinyint(1) DEFAULT 0,
            ...
            KEY publish_deadline (publish_deadline),
            KEY event_type (event_type),
            KEY ready_to_release (ready_to_release),
