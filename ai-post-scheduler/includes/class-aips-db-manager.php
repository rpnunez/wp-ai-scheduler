...
class AIPS_DB_Manager {
    ...
    public function get_schema() {
        ...
        $sql[] = "CREATE TABLE $table_templates (
            ...
            ai_model_standard varchar(100) DEFAULT NULL,
            ai_model_light varchar(100) DEFAULT NULL,
            created_at bigint(20) unsigned NOT NULL DEFAULT 0,
            updated_at bigint(20) unsigned NOT NULL DEFAULT 0,
            PRIMARY KEY  (id),
            KEY campaign_id (campaign_id)
        ...
        $sql[] = "CREATE TABLE $table_authors (
            ...
            source_group_ids text DEFAULT NULL,
            is_active tinyint(1) DEFAULT 1,
            topic_standard_model varchar(100) DEFAULT NULL,
            topic_light_model varchar(100) DEFAULT NULL,
            post_standard_model varchar(100) DEFAULT NULL,
            post_light_model varchar(100) DEFAULT NULL,
            created_at bigint(20) unsigned NOT NULL DEFAULT 0,
            updated_at bigint(20) unsigned NOT NULL DEFAULT 0,
            PRIMARY KEY  (id),
            KEY article_structure_id (article_structure_id),
