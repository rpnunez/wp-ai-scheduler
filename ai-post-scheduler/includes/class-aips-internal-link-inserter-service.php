...
class AIPS_Internal_Link_Inserter_Service {
	...
	/**
	 * @var AIPS_Prompt_Builder_Internal_Link
	 */
	 ...
	 * @param AIPS_Prompt_Builder_Internal_Link|null $prompt_builder Prompt builder.
	 */
	public function __construct(
		...
		$this->prompt_builder = $prompt_builder ?: new AIPS_Prompt_Builder_Internal_Link();
	}
	...
	public function find_insertion_locations($suggestion_id) {
		...
		$prompt = $this->prompt_builder->build($plain_text_content, $post_title, $anchor_text, $target_url, self::NUM_LOCATIONS_TO_REQUEST);
