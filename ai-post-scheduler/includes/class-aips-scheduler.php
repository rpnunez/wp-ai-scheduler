...
class AIPS_Scheduler {
    ...
    public function process_scheduled_posts() {
        ...
        foreach ($due_schedules as $schedule) {
            $this->process_single_schedule($schedule, $logger, $generator);
        }
    }
     ...
     *
     * @param object $schedule The schedule object (joined with template).
     * @param AIPS_Logger $logger Logger instance.
     * @param AIPS_Generator $generator Generator instance.
     */
    private function process_single_schedule($schedule, $logger, $generator) {
