...
/**
 * Class AIPS_Settings_Controller
 *
 * Handles the registration of settings, their fields, and related AJAX actions.
 * Extracted from AIPS_Settings to separate Logic/Data from UI/Presentation.
 *
