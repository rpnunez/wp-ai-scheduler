...
class AIPS_Structures_Controller {
    ...
    public function ajax_save_structure() {
        ...
        if ($id) {
            $result = $manager->update_structure($id, $name, $sections, $prompt_template, $description, $is_active == 1);
            ...
            $new_id = $manager->create_structure($name, $sections, $prompt_template, $description, $is_active == 1);
