...
class AIPS_History_Repository implements AIPS_History_Repository_Interface {
    ...
    /**
     * Legacy proxy method. Delegated to AIPS_History_Stats_Repository.
     * @deprecated
     */
    public function get_daily_success_failure_trend($days = 14) {
        return AIPS_History_Stats_Repository::instance()->get_daily_success_failure_trend($days);
    }
    ...
    public function get_average_duration_by_flow($days = 14) {
        return AIPS_History_Stats_Repository::instance()->get_average_duration_by_flow($days);
    }
    ...
    public function get_retry_counts_by_service($days = 14) {
        return AIPS_History_Stats_Repository::instance()->get_retry_counts_by_service($days);
    }
    /**
     * Legacy proxy method. Delegated to AIPS_History_Stats_Repository.
     * @deprecated
    ...
    public function get_top_failure_reasons($days = 14, $limit = 8) {
        return AIPS_History_Stats_Repository::instance()->get_top_failure_reasons($days, $limit);
    }
     ...
     * @deprecated Legacy proxy method. Delegated to AIPS_History_Stats_Repository.
    ...
    public function get_estimated_generation_time($limit = 20) {
        return AIPS_History_Stats_Repository::instance()->get_estimated_generation_time($limit);
    }
    /**
     * Legacy proxy method. Delegated to AIPS_History_Stats_Repository.
     * @deprecated
    ...
    public function get_stats() {
        return AIPS_History_Stats_Repository::instance()->get_stats();
    }
    ...
    public function get_daily_generation_counts($days = 14) {
        return AIPS_History_Stats_Repository::instance()->get_daily_generation_counts($days);
    }
    ...
    public function get_template_stats($template_id) {
        return AIPS_History_Stats_Repository::instance()->get_template_stats($template_id);
    }
    ...
    public function get_all_template_stats() {
        return AIPS_History_Stats_Repository::instance()->get_all_template_stats();
    }
    ...
    public function get_schedule_generated_post_counts($history_ids) {
        return AIPS_History_Stats_Repository::instance()->get_schedule_generated_post_counts($history_ids);
    }
