...
class AIPS_History_Repository implements AIPS_History_Repository_Interface {
    ...
    public function __construct() {
        ...
        $this->stats_repository = new AIPS_History_Stats_Repository($wpdb, $this->table_name, $this->table_name_log);
    }
     ...
     * Proxy to AIPS_History_Stats_Repository for backward compatibility.
     */
