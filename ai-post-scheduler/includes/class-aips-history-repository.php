...
class AIPS_History_Repository {
    ...
    public function get_history($args = array()) {
        ...
        // Bolt: Select specific columns to optimize performance
        $results = $this->wpdb->get_results($this->wpdb->prepare("
            SELECT h.id, h.status, h.generated_title, h.created_at, h.completed_at, h.template_id, h.post_id, h.error_message, t.name as template_name
