...
class AIPS_History_Repository {
     ...
     * @param int    $history_type_id Optional. History type constant from AIPS_History_Type. Default LOG (1).
     * @return int|false The inserted ID on success, false on failure.
     */
    public function add_log_entry($history_id, $log_type, $details, $history_type_id = 1) {
        $insert_data = array(
