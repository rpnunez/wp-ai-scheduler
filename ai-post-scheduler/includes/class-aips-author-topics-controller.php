...
class AIPS_Author_Topics_Controller {
	...
	/**
	 * @var AIPS_Author_Topics_Bulk_Controller Bulk actions handler
	 */
	...
	public function __construct($expansion_service = null, $history_repository = null, $bulk_generator_service = null) {
		...
		// Instantiate the bulk actions controller.
		$this->bulk_controller = new AIPS_Author_Topics_Bulk_Controller(
			$this->repository,
			$this->logs_repository,
			$this->feedback_repository,
			$this->post_generator,
			$this->history_service,
			$this->bulk_generator_service
		);

		// Register AJAX endpoints for standard topic actions
