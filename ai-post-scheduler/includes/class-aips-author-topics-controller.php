...
class AIPS_Author_Topics_Controller {
	...
	public function __construct($expansion_service = null, ?AIPS_History_Repository_Interface $history_repository = null, $bulk_generator_service = null, ?AIPS_Job_Scheduler $job_scheduler = null) {
		...
		$this->repository             = $container->makeIfExists(AIPS_Author_Topics_Repository::class, AIPS_Author_Topics_Repository::class);
		$this->logs_repository        = $container->makeIfExists(AIPS_Author_Topic_Logs_Repository::class, AIPS_Author_Topic_Logs_Repository::class);
		$this->feedback_repository    = $container->makeIfExists(AIPS_Feedback_Repository::class, AIPS_Feedback_Repository::class);
		$this->post_generator         = $container->makeIfExists(AIPS_Author_Post_Generator::class, AIPS_Author_Post_Generator::class);
		$this->penalty_service        = $container->makeIfExists(AIPS_Topic_Penalty_Service::class, AIPS_Topic_Penalty_Service::class);
