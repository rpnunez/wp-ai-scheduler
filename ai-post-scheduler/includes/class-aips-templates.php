...
class AIPS_Templates {
    ...
    public function __construct() {
        ...
        $this->repository = $container->make(AIPS_Template_Repository::class);
    ...
    public function save($data) {
        ...
        $template_data = array(
            ...
            'generate_featured_image' => isset($data['generate_featured_image']) ? (int) $data['generate_featured_image'] : 0,
