...
class AIPS_Schedule_Repository {
    ...
    /**
     * Update next_run only if the current value matches the expected value.
     *
     * Implements optimistic locking to prevent race conditions.
     *
     * @param int    $id           Schedule ID.
     * @param string $new_next_run New timestamp.
     * @param string $old_next_run Expected current timestamp.
     * @return bool True if updated, false if condition failed (already claimed/updated).
     */
