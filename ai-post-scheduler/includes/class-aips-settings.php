 ...
 * Class AIPS_Settings
 *
 * Handles the registration of plugin settings and rendering of admin interfaces
...
class AIPS_Settings {
    ...
    /**
     * @var AIPS_Admin_Menu Menu handler.
     */
    private $admin_menu;

    /**
     * @var AIPS_Admin_Assets Asset handler.
     */
     ...
     *
     * Hooks into admin_init and orchestrates menu and assets.
     */
    public function __construct() {
        // Instantiate decoupled components
        $this->admin_menu = new AIPS_Admin_Menu($this);
    ...
    // add_menu_pages moved to AIPS_Admin_Menu
    ...
    // enqueue_admin_assets moved to AIPS_Admin_Assets
