...
class AIPS_Settings {
    ...
    public function __construct() {
        // Instantiate the settings controller to register settings hooks
        $this->settings_controller = new AIPS_Settings_Controller();
     ...
     *
     * Delegates rendering to the settings controller.
     *
     * @return void
     */
