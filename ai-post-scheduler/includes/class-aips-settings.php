...
class AIPS_Settings {
    ...
    public function __construct() {
        $this->renderer = new AIPS_Admin_Renderer();
    ...
    public function add_menu_pages() {
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-activity',
            array($this->renderer, 'render_activity_page')
        );
        ...
        add_submenu_page(
            ...
            array($this->renderer, 'render_generated_posts_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-post-review',
            array($this->renderer, 'render_post_review_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-schedule',
            array($this->renderer, 'render_schedule_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-templates',
            array($this->renderer, 'render_templates_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-authors',
            array($this->renderer, 'render_authors_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-voices',
            array($this->renderer, 'render_voices_page')
        );
         ...
         add_submenu_page(
             ...
             'manage_options',
             'aips-research',
             array($this->renderer, 'render_research_page')
         );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-structures',
            array($this->renderer, 'render_structures_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-seeder',
            array($this->renderer, 'render_seeder_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-status',
            array($this->renderer, 'render_status_page')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'aips-settings',
            array($this->renderer, 'render_settings_page')
        );
        ...
        if (get_option('aips_developer_mode')) {
            add_submenu_page(
                ...
                'manage_options',
                'aips-dev-tools',
                array($this->renderer, 'render_dev_tools_page')
            );
        }
    }
