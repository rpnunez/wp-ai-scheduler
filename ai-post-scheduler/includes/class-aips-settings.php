 ...
 * Class AIPS_Settings
 *
 * Handles the registration of settings and rendering of admin interfaces
...
class AIPS_Settings {
     ...
     *
     * Hooks into admin_init and instantiates admin components.
     */
    public function __construct() {
        // Instantiate admin components
        // AIPS_Admin_Menu hooks into admin_menu inside its constructor
        $this->admin_menu = new AIPS_Admin_Menu($this);
        
        // AIPS_Admin_Assets hooks into admin_enqueue_scripts inside its constructor
