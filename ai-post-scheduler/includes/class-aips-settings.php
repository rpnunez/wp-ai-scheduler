...
class AIPS_Settings {
     ...
     *
     * Implements Proposal B navigation structure with grouped sections:
     * - Dashboard
    ...
    public function add_menu_pages() {
        ...
        $this->add_section_header('content-studio', __('— Content Studio —', 'ai-post-scheduler'));
        ...
        $this->add_section_header('planning', __('— Planning —', 'ai-post-scheduler'));
        ...
        $this->add_section_header('publishing', __('— Publishing —', 'ai-post-scheduler'));
        ...
        $this->add_section_header('monitoring', __('— Monitoring —', 'ai-post-scheduler'));
        ...
        $this->add_section_header('system', __('— System —', 'ai-post-scheduler'));
    ...
    /**
     * Add a section header to the admin menu.
     *
     * Section headers are non-clickable menu items that visually group related pages.
     *
