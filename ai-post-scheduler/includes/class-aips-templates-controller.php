 ...
 *
 * Handles AJAX requests for templates.
 */
class AIPS_Templates_Controller {
    ...
    public function __construct(AIPS_Templates $templates_service = null) {
        $this->templates_service = $templates_service ?: new AIPS_Templates();
    ...
    public function ajax_save_template() {
        ...
        $id = $this->templates_service->save($data);
    ...
    public function ajax_delete_template() {
        ...
        if ($this->templates_service->delete($id)) {
    ...
    public function ajax_get_template() {
        ...
        $template = $this->templates_service->get($id);
