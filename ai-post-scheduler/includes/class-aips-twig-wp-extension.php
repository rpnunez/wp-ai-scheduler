...
class AIPS_Twig_WP_Extension extends \Twig\Extension\AbstractExtension {
	...
	public function getFunctions() {
		return array(
			...
			new \Twig\TwigFunction('admin_url', 'admin_url'),
			new \Twig\TwigFunction('add_query_arg', 'add_query_arg'),
			new \Twig\TwigFunction('remove_query_arg', 'remove_query_arg'),
			new \Twig\TwigFunction('aips_page_url', array($this, 'aips_page_url')),
