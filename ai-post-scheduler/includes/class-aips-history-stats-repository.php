 ...
 *
 * Database abstraction layer for history statistics and analytical operations.
 *
 ...
 *
 * Handles statistical and analytical queries for history data.
 */
class AIPS_History_Stats_Repository {
     ...
     * @param string $table_name     The history table name.
     * @param string $table_name_log The history log table name.
     */
    ...
    /**
     * Get estimated generation time based on recent records.
     *
     * @param int $limit Number of recent records to sample.
     * @return array
     */
