 ...
 *
 * Database abstraction layer for complex history analytics and statistics operations.
 * Extracts these concerns from the main History Repository to enforce Separation of Concerns.
 *
 ...
 *
 * Repository pattern implementation for history analytics and statistics.
 */
class AIPS_History_Stats_Repository {
     ...
     * @param string $schedule_table Schedule table name.
     */
    public function __construct($wpdb, $table_name, $table_name_log, $schedule_table) {
        $this->wpdb = $wpdb;
