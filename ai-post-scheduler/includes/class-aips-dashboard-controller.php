...
class AIPS_Dashboard_Controller {
     ...
     *
     * Fetches statistics, pending-review counts, and recent activity from
     * the database to populate the dashboard template.
     *
     * @return void
     */
    public function render_page() {
        ...
        $pending_review_count  = $post_review_repo->get_draft_count();
