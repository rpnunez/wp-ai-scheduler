...
class HistoryContainer {
     ...
     * @return HistoryContainer|null Container instance or null if not found
     */
     ...
     * @return HistoryContainer|\WP_Error
     */
    ...
    /**
     * Get the logical history container type.
     *
     * @return string
     */
    ...
    private function map_log_type_to_history_type($log_type) {
        $map = array(
            'activity' => HistoryType::ACTIVITY,
            'ai_request' => HistoryType::AI_REQUEST,
            'ai_response' => HistoryType::AI_RESPONSE,
            'error' => HistoryType::ERROR,
            'warning' => HistoryType::WARNING,
            'info' => HistoryType::INFO,
            'debug' => HistoryType::DEBUG,
            'log' => HistoryType::LOG,
        );

        return isset($map[$log_type]) ? $map[$log_type] : HistoryType::LOG;
    }
