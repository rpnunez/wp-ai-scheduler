...
use AIPS\Repository\AuthorTopicLogs as AuthorTopicLogsRepository;
use AIPS\Repository\AuthorTopics as AuthorTopicsRepository;
use AIPS\Repository\Feedback as FeedbackRepository;
use AIPS\Service\TopicExpansion as TopicExpansionService;
use AIPS\Service\TopicPenalty as TopicPenaltyService;
use AIPS_Author_Post_Generator;
...
class AuthorTopics {
	...
	/**
	 * @var AuthorTopicsRepository Repository for topics
	 */
	private $repository;

	/**
	 * @var AuthorTopicLogsRepository Repository for logs
	 */
	private $logs_repository;

	/**
	 * @var FeedbackRepository Repository for feedback
	 */
	...
	/**
	 * @var TopicPenaltyService Penalty service
	 */
	private $penalty_service;

	/**
	 * @var ActivityRepository Repository for activity logging
	 */
	...
	public function __construct() {
		$this->repository = new AuthorTopicsRepository();
		$this->logs_repository = new AuthorTopicLogsRepository();
		$this->feedback_repository = new FeedbackRepository();
		$this->post_generator = new AIPS_Author_Post_Generator();
		$this->penalty_service = new TopicPenaltyService();
	...
	public function ajax_get_similar_topics() {
		...
		$expansion_service = new TopicExpansionService();
