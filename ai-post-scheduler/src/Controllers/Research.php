...
use AIPS\Repository\TrendingTopics as TrendingTopicsRepository;
use AIPS\Service\Research as ResearchService;
...
class Research {
	...
	/**
	 * @var ResearchService Research service instance
	 */
	private $research_service;

	/**
	 * @var TrendingTopicsRepository Repository instance
	 */
	private $repository;
