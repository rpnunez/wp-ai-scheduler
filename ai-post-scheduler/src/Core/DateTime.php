<?php
/**
 * DateTime — Immutable, UTC-first date/time value object.
 *
 ...
 * {@see DateTime::now()->timestamp()} when writing and
 * {@see DateTime::fromTimestamp()} when reading.
 *
...
class DateTime extends DateTimeImmutable {
	...
	/**
	 * Wrap any DateTimeInterface as a DateTime in the same timezone.
	 *
