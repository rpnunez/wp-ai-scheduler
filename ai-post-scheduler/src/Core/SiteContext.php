 ...
 * AIPS\Settings\Settings::get_content_strategy_options(), so adding a new site-wide
...
use AIPS\Settings\Settings;

/**
 * Class SiteContext
 *
 * Static utility that reads site-wide content strategy options.
 * The option registry lives in AIPS\Settings\Settings::get_content_strategy_options()
...
class SiteContext {
	...
	public static function get() {
		...
		$options = Settings::get_content_strategy_options();
	 ...
	 *                            When omitted (null) the Config registered default is used,
