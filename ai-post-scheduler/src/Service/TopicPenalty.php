...
class TopicPenalty {
	...
	/**
	 * @var AuthorTopicsRepository Topics repository
	 */
	private $topics_repository;

	/**
	 * @var AuthorsRepository Authors repository
	 */
	...
	public function __construct($topics_repository = null, $authors_repository = null, $logger = null) {
		$this->topics_repository = $topics_repository ?: new AuthorTopicsRepository();
		$this->authors_repository = $authors_repository ?: new AuthorsRepository();
