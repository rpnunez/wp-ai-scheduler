...
class Image {
	...
	/**
	 * @var AI AI Service instance for image generation
	 */
	private $ai_service;
	 ...
	 *
	 * @param AI|null $ai_service Optional AI Service instance. Creates new if not provided.
	 */
	public function __construct($ai_service = null) {
		$this->ai_service = $ai_service ? $ai_service : new AI();
