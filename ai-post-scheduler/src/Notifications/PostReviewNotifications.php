...
namespace AIPS\Notifications;

use AIPS\Services\HistoryService;
use AIPS\Repositories\PostReviewRepository;
...
class PostReviewNotifications {
    ...
    public function send_review_notification_email() {
        ...
        $repository = new PostReviewRepository();
        ...
        <body>
            <div class="email-container">
                ...
                <div class="email-body">
                    ...
                    <p><em><?php echo esc_html(sprintf(__('...and %d more posts', 'ai-post-scheduler'), $total_count - 10)); ?></em></p>
                    <?php endif; ?>
                    <?php endif; ?>
                ...
                <div class="email-footer">
                    ...
                    <p><?php esc_html_e('To disable these notifications, visit the plugin settings page.', 'ai-post-scheduler'); ?></p>
                </div>
            </div>
        </body>
        </html>
