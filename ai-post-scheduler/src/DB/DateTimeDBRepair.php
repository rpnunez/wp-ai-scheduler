...
class DateTimeDBRepair {
	 ...
	 *
	 * Delegates to DBManager::convert_datetime_column_to_bigint() which
	...
	private function convert_legacy_datetime_column_to_bigint( $table, $col_name ) {
		return DBManager::convert_datetime_column_to_bigint( $table, $col_name );
	}
	...
	private function normalize_db_datetime_value( $value ) {
		...
		$parsed = DateTime::fromMysqlOrNull( (string) $value );
