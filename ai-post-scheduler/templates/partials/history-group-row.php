...
<tr class="aips-history-group-header" data-group-id="<?php echo esc_attr($group_id); ?>" aria-expanded="false">
    ...
    <td class="column-title">
        ...
        <span class="aips-history-subtitle aips-group-subtitle"><?php esc_html_e('Click to expand', 'ai-post-scheduler'); ?></span>
    </td>
    <td class="column-post-type">
        <?php if (!empty($post_types)): ?>
            <?php foreach ($post_types as $pt_name): ?>
                <span class="aips-badge aips-badge-neutral">
                    <?php echo esc_html(AIPS_History::humanize_post_type_label($pt_name)); ?>
                </span>
            <?php endforeach; ?>
        <?php else: ?>
