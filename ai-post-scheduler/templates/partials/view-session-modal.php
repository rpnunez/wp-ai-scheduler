		...
		<div class="aips-modal-body">
			...
			<div class="aips-tabs">
				<ul class="aips-tab-nav">
					...
					<li><a href="#aips-tab-explainability"><?php esc_html_e('Explainability', 'ai-post-scheduler'); ?></a></li>
				</ul>
				...
				<div id="aips-tab-explainability" class="aips-tab-content" style="display: none;">
					<div id="aips-explainability-list"></div>
				</div>
			</div>
		</div>
	</div>
