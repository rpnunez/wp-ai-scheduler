...
<div id="aips-post-preview-modal" class="aips-modal" style="display: none;" role="dialog" aria-modal="true" aria-labelledby="aips-post-preview-modal-title">
	...
	<div class="aips-modal-content" style="width: 90%; max-width: 1200px; height: 90vh;">
		...
		<div class="aips-modal-body" style="height: calc(100% - 60px); padding: 0;">
			...
			<iframe id="aips-post-preview-iframe" src="" title="<?php echo esc_attr__('Post preview content', 'ai-post-scheduler'); ?>" style="width: 100%; height: 100%; border: none; display: none;"></iframe>
		</div>
	</div>
</div>
