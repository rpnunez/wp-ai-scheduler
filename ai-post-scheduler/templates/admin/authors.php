                                ...
                                <tr data-author-id="<?php echo esc_attr($author->id); ?>">
                                    ...
                                    <td>
                                        <?php if ($posts_count > 0): ?>
                                            <button type="button" class="button-link aips-view-author-posts" data-id="<?php echo esc_attr($author->id); ?>" title="<?php esc_attr_e('View Posts', 'ai-post-scheduler'); ?>">
                                                <strong style="font-size: 14px; text-decoration: underline;"><?php echo esc_html($posts_count); ?></strong>
                                            </button>
                                        <?php else: ?>
                                            <strong style="font-size: 14px; color: #aaa;"><?php echo esc_html($posts_count); ?></strong>
                                        <?php endif; ?>
                                    </td>
                                    <td>
...
<!-- Author Posts Modal -->
<div id="aips-author-posts-modal" class="aips-modal" style="display: none;">
    <div class="aips-modal-content aips-modal-large">
        <button type="button" class="aips-modal-close" aria-label="<?php esc_attr_e('Close modal', 'ai-post-scheduler'); ?>">&times;</button>
        <h2 id="aips-author-posts-modal-title"><?php esc_html_e('Posts Generated by Author', 'ai-post-scheduler'); ?></h2>
        <div id="aips-author-posts-content">
            <p><?php esc_html_e('Loading posts...', 'ai-post-scheduler'); ?></p>
        </div>
    </div>
</div>