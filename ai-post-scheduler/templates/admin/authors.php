			...
			<div class="aips-topics-tabs">
                ...
                <div class="aips-topics-list-container">
                    ...
                    <div class="aips-filter-bar" style="margin-bottom: 15px;">
                        ...
                        <input type="search" id="aips-topic-search" class="aips-form-input" style="max-width: 300px;" placeholder="<?php esc_attr_e('Search topics...', 'ai-post-scheduler'); ?>">
                    ...
                    <div class="aips-pagination" style="margin-top: 15px; text-align: right;"></div>
