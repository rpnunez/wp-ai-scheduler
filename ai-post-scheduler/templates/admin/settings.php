        ...
        <table class="widefat striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <code>{{topic}}</code>
                        <button type="button" class="button button-small aips-copy-btn" data-clipboard-text="{{topic}}" aria-label="<?php esc_attr_e('Copy variable', 'ai-post-scheduler'); ?>">
                            <span class="dashicons dashicons-clipboard"></span>
                        </button>
                    </td>
                    <td><?php esc_html_e('Current Topic', 'ai-post-scheduler'); ?></td>
                    <td><?php esc_html_e('The topic of the post (alias: {{title}})', 'ai-post-scheduler'); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
