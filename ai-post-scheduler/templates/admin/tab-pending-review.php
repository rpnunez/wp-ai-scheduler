				...
				<div class="aips-filter-bar">
					<form method="get" class="aips-post-review-filters aips-filter-form">
						...
						<div class="aips-filter-left">
							...
							<a href="<?php echo esc_url(remove_query_arg(array('template_id', 'post_type'))); ?>" class="aips-btn aips-btn-sm aips-btn-ghost"><?php esc_html_e('Clear Filters', 'ai-post-scheduler'); ?></a>
							<?php endif; ?>
						</div>
