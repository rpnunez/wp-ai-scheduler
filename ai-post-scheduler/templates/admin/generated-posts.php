...
<div class="wrap">
    ...
    <div class="aips-actions-bar" style="margin-bottom: 15px; display: flex; justify-content: flex-end;">
        <button type="button" id="aips-clear-history" class="button button-secondary">
            <span class="dashicons dashicons-trash" style="line-height: 1.3;"></span>
            <?php esc_html_e('Clear All History', 'ai-post-scheduler'); ?>
        </button>
    </div>
