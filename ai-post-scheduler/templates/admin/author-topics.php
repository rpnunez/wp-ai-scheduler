...
$active_topic_tab = isset($_GET['topic_status']) ? sanitize_key(wp_unslash($_GET['topic_status'])) : 'pending';

if (!in_array($active_topic_tab, array('pending', 'approved', 'rejected', 'posts_generated', 'feedback'), true)) {
	$active_topic_tab = 'pending';
}
...
$initial_result_count = isset($status_counts[ $active_topic_tab ]) ? (int) $status_counts[ $active_topic_tab ] : 0;
?>
<div class="aips-content-panel" id="aips-author-topics-panel">
			<!-- Tabs -->
			<div class="aips-topics-tabs aips-page-tabs">
				<button type="button" class="aips-author-topics-tab<?php echo ('pending' === $active_topic_tab) ? ' active' : ''; ?>" data-topic-tab="pending">
				...
				<button type="button" class="aips-author-topics-tab<?php echo ('approved' === $active_topic_tab) ? ' active' : ''; ?>" data-topic-tab="approved">
				...
				<button type="button" class="aips-author-topics-tab<?php echo ('rejected' === $active_topic_tab) ? ' active' : ''; ?>" data-topic-tab="rejected">
				...
				<button type="button" class="aips-author-topics-tab<?php echo ('posts_generated' === $active_topic_tab) ? ' active' : ''; ?>" data-topic-tab="posts_generated">
				...
				<button type="button" class="aips-author-topics-tab<?php echo ('feedback' === $active_topic_tab) ? ' active' : ''; ?>" data-topic-tab="feedback">
		...
		<div class="tablenav">
			<span class="aips-table-footer-count" id="aips-topics-result-count">
				...
				printf(
					...
					number_format_i18n($initial_result_count)
				);
				?>
			</span>
		</div>
