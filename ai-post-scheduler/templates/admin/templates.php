            ...
            <div class="aips-modal-body">
                <form id="aips-template-form">
                    ...
                    <div class="aips-wizard-step-content" data-step="2" style="display: none;">
                        ...
                        <div class="aips-form-row">
                            <label for="template_language"><?php esc_html_e('Content Language', 'ai-post-scheduler'); ?></label>
                            <select id="template_language" name="language">
                                ...
                                <option value="da"><?php esc_html_e('Danish', 'ai-post-scheduler'); ?></option>
                                <option value="fi"><?php esc_html_e('Finnish', 'ai-post-scheduler'); ?></option>
                                <option value="nb"><?php esc_html_e('Norwegian', 'ai-post-scheduler'); ?></option>
                            </select>
                            <p class="description"><?php esc_html_e('Language for all content generated by this template. Overrides the site-wide language setting.', 'ai-post-scheduler'); ?></p>
                        </div>
    ...
    <div id="aips-test-result-modal" class="aips-modal" style="display: none;">
        <div class="aips-modal-content aips-modal-large">
            ...
            <div class="aips-modal-footer">
                <button type="button" class="aips-btn aips-btn-secondary aips-modal-close" aria-label="<?php esc_attr_e('Close modal', 'ai-post-scheduler'); ?>"><?php esc_html_e('Close', 'ai-post-scheduler'); ?></button>
            </div>
        </div>
    </div>
