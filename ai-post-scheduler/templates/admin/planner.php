    ...
    <div id="planner-results" class="aips-card" style="display:none; margin-top: 20px;">
        ...
        <div class="aips-toolbar">
            ...
            <div class="aips-toolbar-right">
                <button type="button" id="btn-copy-topics" class="button button-small" aria-label="<?php echo esc_attr__('Copy selected topics to clipboard', 'ai-post-scheduler'); ?>">
                    <?php echo esc_html__('Copy Selected', 'ai-post-scheduler'); ?>
                </button>
                <button type="button" id="btn-clear-topics" class="button-link button-link-delete" aria-label="<?php echo esc_attr__('Clear all topics from list', 'ai-post-scheduler'); ?>">
