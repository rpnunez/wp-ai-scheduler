        ...
        <div class="aips-panel-body">
            <div class="aips-toolbar aips-planner-toolbar">
                ...
                <div class="aips-toolbar-right aips-planner-toolbar-right">
                    ...
                    <button type="button" id="planner-topic-search-clear" class="aips-btn aips-btn-sm aips-btn-secondary" style="display: none;"><?php esc_html_e('Clear Search', 'ai-post-scheduler'); ?></button>
