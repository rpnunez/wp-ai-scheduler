			...
			<table class="wp-list-table widefat fixed striped aips-structures-list">
				...
				<tbody>
					...
					<tr data-structure-id="<?php echo esc_attr($structure->id); ?>">
						...
						<td>
							<button class="button aips-clone-structure" data-id="<?php echo esc_attr($structure->id); ?>" aria-label="<?php esc_attr_e('Clone structure', 'ai-post-scheduler'); ?>">
			...
			<table class="wp-list-table widefat fixed striped aips-sections-list">
				...
				<tbody>
					...
					<tr data-section-id="<?php echo esc_attr($section->id); ?>">
						...
						<td>
							<button class="button aips-clone-section" data-id="<?php echo esc_attr($section->id); ?>" aria-label="<?php esc_attr_e('Clone section', 'ai-post-scheduler'); ?>">
								<?php esc_html_e('Clone', 'ai-post-scheduler'); ?>
							</button>
