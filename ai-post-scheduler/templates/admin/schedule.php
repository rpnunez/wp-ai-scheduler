...
if (!function_exists('aips_type_badge')) {
	function aips_type_badge($type) {
		switch ($type) {
			...
			case AIPS_Unified_Schedule_Service::TYPE_EXISTING_POST_SCAN:
				return '<span class="aips-badge aips-badge-type-template">' . esc_html__('Existing Post Scan', 'ai-post-scheduler') . '</span>';
		}
		return '';
	}
}
...
if (!function_exists('aips_run_output_label')) {
	function aips_run_output_label($type) {
		...
		if ($type === AIPS_Unified_Schedule_Service::TYPE_EXISTING_POST_SCAN) {
			return __('Generated existing-post suggestions', 'ai-post-scheduler');
		}
		...
		<div class="aips-page-header">
			<div class="aips-page-header-top">
				<div>
					...
					<p class="aips-page-description"><?php esc_html_e('All scheduled processes — template post generation, author topic generation, author post generation, and existing-post scans — in one view.', 'ai-post-scheduler'); ?></p>
				</div>
