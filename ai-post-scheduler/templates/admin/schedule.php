            ...
            <tbody>
                ...
                <tr data-schedule-id="<?php echo esc_attr($schedule->id); ?>"
                    ...
                    <td class="column-actions">
                        <button class="button aips-run-schedule-now" data-id="<?php echo esc_attr($schedule->id); ?>" aria-label="<?php esc_attr_e('Run this schedule immediately', 'ai-post-scheduler'); ?>">
