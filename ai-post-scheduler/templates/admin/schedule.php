            ...
            <tbody>
                ...
                <tr data-schedule-id="<?php echo esc_attr($schedule->id); ?>"
                    ...
                    <td class="column-actions">
                        <button class="button aips-run-now" data-id="<?php echo esc_attr($schedule->id); ?>" data-type="schedule" aria-label="<?php esc_attr_e('Run schedule now', 'ai-post-scheduler'); ?>">
