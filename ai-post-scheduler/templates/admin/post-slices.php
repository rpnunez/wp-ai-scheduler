		...
		<div class="aips-content-panel">
			...
			<div class="aips-filter-bar">
				<div class="aips-filter-right">
					<label class="screen-reader-text" for="aips-section-search"><?php esc_html_e('Search Post Slices:', 'ai-post-scheduler'); ?></label>
					<input type="search" id="aips-section-search" class="aips-form-input" placeholder="<?php esc_attr_e('Search post slices...', 'ai-post-scheduler'); ?>">
			...
			<div class="aips-panel-body no-padding">
				<table class="aips-table">
					...
					<tbody>
						<?php foreach ($post_slices as $section) : ?>
			...
			<div class="aips-empty-state">
				...
				<h3 class="aips-empty-state-title"><?php esc_html_e('No Post Slices', 'ai-post-scheduler'); ?></h3>
				<p class="aips-empty-state-description"><?php esc_html_e('Create reusable post slices that can be inserted into your generation workflows.', 'ai-post-scheduler'); ?></p>
				<div class="aips-empty-state-actions">
	...
	<!-- Section Modal (kept as-is for JavaScript compatibility) --><div id="aips-section-modal" class="aips-modal" style="display: none;">
		<div class="aips-modal-content">
			<div class="aips-modal-header">
				<h2 id="aips-section-modal-title"><?php esc_html_e('Add New Post Slice', 'ai-post-scheduler'); ?></h2>
			...
			<div class="aips-modal-footer">
				...
				<button type="button" class="button button-primary aips-save-section"><?php esc_html_e('Save Post Slice', 'ai-post-scheduler'); ?></button>
			</div>
		</div>
	</div>
</div>
