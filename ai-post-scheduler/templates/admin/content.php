 ...
 * Tab 4: Existing Posts      - @see templates/admin/tab-existing-posts.php
 *
...
<div class="wrap aips-wrap">
	<div class="aips-page-container">
		...
		<div class="aips-tab-nav">
			...
			<a href="#aips-existing-posts" class="aips-tab-link" data-tab="aips-existing-posts"><?php esc_html_e('Existing Posts', 'ai-post-scheduler'); ?></a>
		</div>
		...
		<!-- Tab 4: Existing Posts -->
		<div id="aips-existing-posts-tab" class="aips-tab-content" style="display:none;" role="tabpanel" aria-hidden="true">
			<div class="aips-content-panel">
				<?php include AIPS_PLUGIN_DIR . 'templates/admin/tab-existing-posts.php'; ?>
			</div>
		</div>
	</div>
</div>
...
// Include Existing Post review modal partial
include AIPS_PLUGIN_DIR . 'templates/partials/existing-post-review-modal.php';
?>
