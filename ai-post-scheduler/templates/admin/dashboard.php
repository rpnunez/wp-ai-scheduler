    ...
    <div class="aips-page-container" id="aips-dashboard-panel">
        ...
        <div class="aips-content-panel outlook-panel glass-morphic">
            ...
            <div class="aips-panel-body">
                ...
                <?php else: ?>
                <div class="aips-empty-state" style="padding: 20px 0;">
                    <span class="dashicons dashicons-calendar-alt aips-empty-state-icon" style="font-size:36px; width:36px; height:36px;"></span>
                    <p class="aips-empty-state-description" style="margin-bottom:0;"><?php esc_html_e('No automated runs scheduled for the next 30 days. Check your schedule configurations.', 'ai-post-scheduler'); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <!-- 2. DETAIL SECTION -->
        <div class="aips-dashboard-section-title" style="margin-top: 40px;">
        ...
        <div class="aips-dashboard-detail-grid">
            ...
            <div class="aips-content-panel detail-tabs-panel glass-morphic">
                ...
                <div class="aips-tab-headers" role="tablist">
                    ...
                    <button class="aips-tab-btn" role="tab" aria-selected="false" aria-controls="tab-topics" id="btn-tab-topics">
                        <span class="dashicons dashicons-lightbulb"></span>
                        <?php esc_html_e('Persona Topics', 'ai-post-scheduler'); ?>
                    </button>
                ...
                <div class="aips-tab-content">
                            ...
                            <table class="aips-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php esc_html_e('Completed Date', 'ai-post-scheduler'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="cell-primary"><?php echo esc_html($item->template_name ?: __('Custom Persona Workflow', 'ai-post-scheduler')); ?></span>
                    ...
                    <div class="aips-tab-panel" id="tab-topics" role="tabpanel" aria-labelledby="btn-tab-topics" style="display:none;" aria-hidden="true">
                            ...
                            <table class="aips-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php esc_html_e('Author Persona', 'ai-post-scheduler'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="cell-primary"><?php echo esc_html($item->author_name ?: __('Unknown Persona', 'ai-post-scheduler')); ?></div>
                                        </td>
                                        <td>
                        ...
                        <div class="aips-empty-state">
                            ...
                            <p class="aips-empty-state-description"><?php esc_html_e('No persona topics were generated in the selected date range.', 'ai-post-scheduler'); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="aips-tab-panel" id="tab-topic-posts" role="tabpanel" aria-labelledby="btn-tab-topic-posts" style="display:none;" aria-hidden="true">
                        ...
                        <div class="aips-table-wrap">
                            <table class="aips-table">
                                <thead>
                                    <tr>
                                        <th><?php esc_html_e('Created Post', 'ai-post-scheduler'); ?></th>
                                        <th><?php esc_html_e('Derived Persona Topic', 'ai-post-scheduler'); ?></th>
                                        <th><?php esc_html_e('Author Persona', 'ai-post-scheduler'); ?></th>
                                        <th><?php esc_html_e('Completed Date', 'ai-post-scheduler'); ?></th>
                                    </tr>
                                </thead>
                            ...
                            <table class="aips-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php esc_html_e('Status', 'ai-post-scheduler'); ?></th>
                                        <th><?php esc_html_e('Run Date', 'ai-post-scheduler'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $method_labels = array(
                                                ...
                                                'author_topic_gen' => __('Persona Topic Cron', 'ai-post-scheduler'),
                                                'author_post_gen'  => __('Persona Post Cron', 'ai-post-scheduler'),
            ...
            <div class="aips-dashboard-charts-column">
                ...
                <div class="aips-content-panel glass-morphic">
                    <div class="aips-panel-header">
                        <h2 class="aips-panel-title"><?php esc_html_e('AI Calls & Errors (Daily)', 'ai-post-scheduler'); ?></h2>
                    </div>
                    <div class="aips-panel-body">
