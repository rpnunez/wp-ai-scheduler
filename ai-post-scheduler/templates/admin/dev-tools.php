...
<?php endif; ?>
        ...
        <!-- Seed Configuration (moved from Seeder tab) -->
<?php
$aips_dev_tools_outer_embedded = !empty($embedded);
$embedded = true;
include AIPS_PLUGIN_DIR . 'templates/admin/seeder.php';
$embedded = $aips_dev_tools_outer_embedded;
unset($aips_dev_tools_outer_embedded);
?>
