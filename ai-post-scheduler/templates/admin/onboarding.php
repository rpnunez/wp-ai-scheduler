					...
					<table class="form-table" role="presentation">
						<tbody>
							<tr>
								...
								<td><input type="text" class="regular-text" id="aips_site_niche" name="strategy[aips_site_niche]" value="<?php echo esc_attr($aips_config->get_option('aips_site_niche')); ?>" required></td>
							</tr>
							<tr>
								<th scope="row"><label for="aips_site_target_audience"><?php esc_html_e('Target Audience', 'ai-post-scheduler'); ?></label></th>
								<td><input type="text" class="regular-text" id="aips_site_target_audience" name="strategy[aips_site_target_audience]" value="<?php echo esc_attr($aips_config->get_option('aips_site_target_audience')); ?>"></td>
							</tr>
							<tr>
								<th scope="row"><label for="aips_site_content_goals"><?php esc_html_e('Content Goals', 'ai-post-scheduler'); ?></label></th>
								<td><textarea class="large-text" rows="3" id="aips_site_content_goals" name="strategy[aips_site_content_goals]"><?php echo esc_textarea($aips_config->get_option('aips_site_content_goals')); ?></textarea></td>
							</tr>
							<tr>
								<th scope="row"><label for="aips_site_brand_voice"><?php esc_html_e('Brand Voice / Tone', 'ai-post-scheduler'); ?></label></th>
								<td><input type="text" class="regular-text" id="aips_site_brand_voice" name="strategy[aips_site_brand_voice]" value="<?php echo esc_attr($aips_config->get_option('aips_site_brand_voice')); ?>"></td>
							</tr>
							<tr>
								...
								<td>
									<select id="aips_site_content_language" name="strategy[aips_site_content_language]">
										<?php
										$lang_value = $aips_config->get_option('aips_site_content_language');
										$languages = array(
							...
							<tr>
								...
								<td><textarea class="large-text" rows="3" id="aips_site_content_guidelines" name="strategy[aips_site_content_guidelines]"><?php echo esc_textarea($aips_config->get_option('aips_site_content_guidelines')); ?></textarea></td>
							</tr>
							<tr>
								<th scope="row"><label for="aips_site_excluded_topics"><?php esc_html_e('Excluded Topics (site-wide)', 'ai-post-scheduler'); ?></label></th>
								<td><textarea class="large-text" rows="3" id="aips_site_excluded_topics" name="strategy[aips_site_excluded_topics]"><?php echo esc_textarea($aips_config->get_option('aips_site_excluded_topics')); ?></textarea></td>
							</tr>
						</tbody>
					</table>
					<p>
						...
						<table class="form-table" role="presentation">
							<tbody>
								...
								<tr>
									...
									<td><input type="text" class="regular-text" id="aips_onboarding_author_niche" name="field_niche" value="<?php echo esc_attr($aips_config->get_option('aips_site_niche')); ?>" <?php disabled(!$strategy_complete); ?> required></td>
								</tr>
								<tr>
									<th scope="row"><label for="aips_onboarding_author_voice_tone"><?php esc_html_e('Voice Tone', 'ai-post-scheduler'); ?></label></th>
									<td><input type="text" class="regular-text" id="aips_onboarding_author_voice_tone" name="voice_tone" value="<?php echo esc_attr($aips_config->get_option('aips_site_brand_voice')); ?>" <?php disabled(!$strategy_complete); ?>></td>
								</tr>
								<tr>
									<th scope="row"><label for="aips_onboarding_author_target_audience"><?php esc_html_e('Target Audience', 'ai-post-scheduler'); ?></label></th>
									<td><input type="text" class="regular-text" id="aips_onboarding_author_target_audience" name="target_audience" value="<?php echo esc_attr($aips_config->get_option('aips_site_target_audience')); ?>" <?php disabled(!$strategy_complete); ?>></td>
								</tr>
								<tr>
									<th scope="row"><label for="aips_onboarding_author_goals"><?php esc_html_e('Content Goals', 'ai-post-scheduler'); ?></label></th>
									<td><textarea class="large-text" rows="2" id="aips_onboarding_author_goals" name="content_goals" <?php disabled(!$strategy_complete); ?>><?php echo esc_textarea($aips_config->get_option('aips_site_content_goals')); ?></textarea></td>
								</tr>
								<tr>
									<th scope="row"><label for="aips_onboarding_author_language"><?php esc_html_e('Language', 'ai-post-scheduler'); ?></label></th>
									<td><input type="text" class="small-text" id="aips_onboarding_author_language" name="language" value="<?php echo esc_attr($aips_config->get_option('aips_site_content_language')); ?>" <?php disabled(!$strategy_complete); ?>></td>
								</tr>
								<tr>
		...
		<div class="aips-content-panel" style="margin-top: 20px; opacity: <?php echo $template_complete ? '1' : '0.6'; ?>;">
			...
			<div class="aips-panel-body">
				...
				<?php else : ?>
					...
					<p>
						<button type="button" class="aips-btn aips-btn-primary" id="aips-onboarding-generate-topics" <?php disabled(!$template_complete || !$ai_provider_available); ?>>
		...
		<div class="aips-content-panel" style="margin-top: 20px; opacity: <?php echo $topics_complete ? '1' : '0.6'; ?>;">
			...
			<div class="aips-panel-body">
				...
				<?php else : ?>
					...
					<p>
						<button type="button" class="aips-btn aips-btn-primary" id="aips-onboarding-generate-post" <?php disabled(!$topics_complete || !$ai_provider_available); ?>>
