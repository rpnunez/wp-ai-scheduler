    ...
    <div class="aips-modal-content aips-modal-large">
        <div class="aips-modal-header">
            <div class="aips-history-modal-header-main">
                <h3 id="aips-history-logs-modal-title" class="aips-modal-title"><?php esc_html_e('History Details', 'ai-post-scheduler'); ?></h3>
        ...
        <div class="aips-modal-body aips-modal-content-body" id="aips-history-logs-content">
