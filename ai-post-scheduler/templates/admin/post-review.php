...
// Initialize the Post Review handler if not already done
if (!isset($post_review_handler)) {
	$post_review_handler = new AIPS_Post_Review();
}
...
// Get draft posts
$draft_posts = $post_review_handler->get_draft_posts(array(
	'page' => $current_page,
	'search' => $search_query,
