					...
					<tbody>
						...
						<?php else : ?>
							<?php foreach ($events as $event) : ?>
								...
								$details_url = add_query_arg(array('page' => 'aips-upcoming', 'details' => rawurlencode($event['hook']), 'details_ts' => $event['timestamp'], 'category' => $filter_state['category'], 'window' => $filter_state['window'], 's' => $filter_state['search']), admin_url('admin.php'));
								?>
								<tr>
									<td>
