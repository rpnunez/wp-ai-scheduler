...
<div class="wrap aips-wrap">
	...
	<div class="aips-structures-container">
				...
				<tr data-section-id="<?php echo esc_attr($section->id); ?>">
					...
					<td class="column-key">
						<div class="aips-variable-code-cell">
							...
							<button type="button" class="button button-small aips-copy-btn" data-clipboard-text="<?php echo esc_attr($section->section_key); ?>" aria-label="<?php esc_attr_e('Copy key', 'ai-post-scheduler'); ?>">
		...
		<div id="aips-section-search-no-results" class="aips-empty-state" style="display: none;">
			...
			<p><?php esc_html_e('No sections match your search criteria.', 'ai-post-scheduler'); ?></p>
