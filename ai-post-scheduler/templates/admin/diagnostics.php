	...
	<div class="aips-page-container">
		<div class="aips-page-header">
			<div class="aips-page-header-top">
				<div>
					<h1 class="aips-page-title"><?php esc_html_e('Diagnostics', 'ai-post-scheduler'); ?></h1>
		...
		<div class="aips-tab-nav" role="tablist">
			<?php foreach ($tabs as $tab_key => $tab) : ?>
				...
				<a href="<?php echo esc_url($diagnostics_controller->get_tab_url($tab_key)); ?>" class="<?php echo esc_attr($tab_classes); ?>" role="tab" aria-selected="<?php echo esc_attr($active_tab === $tab_key ? 'true' : 'false'); ?>">
