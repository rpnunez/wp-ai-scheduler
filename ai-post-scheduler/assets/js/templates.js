 ...
 * AIPS Templates
 *
 * Template CRUD, wizard navigation, preview drawer, featured image,
 * and AI Variables scanner.
 *
...
(function($) {
    ...
    var SYSTEM_VARIABLES = [
        ...
        'site_name', 'site_description', 'random_number',
        'topic', 'title'
    ];
    ...
    Object.assign(AIPS, {
        ...
        updateAIVariablesPanel: function(variables) {
            ...
            variables.forEach(function(varName) {
                html += '<span class="aips-ai-var-tag" data-variable="{{' + AIPS.utils.escapeHtml(varName) + '}}" title="Click to copy">';
                html += '<span class="dashicons dashicons-tag"></span>';
                html += '{{' + AIPS.utils.escapeHtml(varName) + '}}';
                html += '</span>';
            });
    ...
    $(document).ready(function() {
        ...
        // Initialize AI Variables scanner
        AIPS.initAIVariablesScanner();
