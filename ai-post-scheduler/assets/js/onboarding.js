jQuery(document).ready(function ($) {
	...
	$('#aips-onboarding-strategy-form').on('submit', function (e) {
		...
		ajax('aips_onboarding_save_strategy', data, function (err, out) {
			...
			if (typeof window.AIPS !== 'undefined' && typeof window.AIPS.refreshContentPanel === 'function') { window.AIPS.refreshContentPanel('.aips-page-container'); } else { window.location.reload(); }
		});
	});
