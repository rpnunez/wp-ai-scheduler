(function($) {
    ...
    Object.assign(AIPS, {
         ...
         * Schedule CRUD, bulk actions, search, history, and auto-open logic are
         * handled by admin-schedules.js on the schedule admin page.
         */
        init: function() {
            this.bindEvents();
        ...
        bindEvents: function() {
            ...
            // Schedule CRUD, bulk actions, search, and history events are handled by admin-schedules.js
