(function($) {
    ...
    Object.assign(AIPS, {
        ...
        clearTemplateSearch: function(e) {
            e.preventDefault();
            $('#aips-template-search').val('').trigger('input').trigger('keyup');
        },
        ...
        clearScheduleSearch: function(e) {
            e.preventDefault();
            $('#aips-schedule-search').val('').trigger('input').trigger('keyup');
        },
        ...
        clearVoiceSearch: function(e) {
            e.preventDefault();
            $('#aips-voice-search').val('').trigger('input').trigger('keyup');
        },
        ...
        clearSectionSearch: function(e) {
            e.preventDefault();
            $('#aips-section-search').val('').trigger('input').trigger('keyup');
        },
        ...
        clearStructureSearch: function(e) {
            e.preventDefault();
            $('#aips-structure-search').val('').trigger('input').trigger('keyup');
        },
        ...
        clearAuthorSearch: function(e) {
            e.preventDefault();
            $('#aips-author-search').val('').trigger('input').trigger('keyup');
        },
