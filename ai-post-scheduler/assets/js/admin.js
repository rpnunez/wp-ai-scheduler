(function($) {
    ...
    Object.assign(AIPS, {
         ...
         *
         * Registers delegated event listeners, runs the initial AI variables
         * scan, and activates any tab referenced by the URL hash.
         */
        init: function() {
            this.bindEvents();
            if (typeof this.initScheduleModule === 'function') {
        ...
        /**
         * Move the template wizard UI to the requested step and refresh
         * progress indicators.
         *
         * Shows only the requested `.aips-wizard-step-content`, updates step
         * markers (`active`/`completed`), toggles Back/Next visibility, and
         * refreshes the summary panel when entering the final step.
         *
         * @param {number} step - 1-based wizard step number to activate.
         */
